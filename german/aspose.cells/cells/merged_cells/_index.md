...
In dieser Sammlung ist jedes Element eine [`CellArea`](/cells/python-net/de/aspose.cells/cellarea)-Struktur, die einen Bereich zusammengeführter Zellen darstellt.
###  Definition:
```python
@property
