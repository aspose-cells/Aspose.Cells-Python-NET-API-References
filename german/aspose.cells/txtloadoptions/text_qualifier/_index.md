...
Beim Setzen dieser Eigenschaft wird [TxtLoadOptions.has_text_qualifier](/cells/python-net/de/aspose.cells/txtloadoptions#has_text_qualifier) automatisch wahr.
###  Definition:
```python
@property
