...
type: docs
weight: 220
url: /de/aspose.cells/range/put_value/
is_root: false
---
##  put_value(self, string_value, is_converted, set_style) {#str-bool-bool}
Setzt einen Wert in den Bereich. Gegebenenfalls wird der Wert in einen anderen Datentyp konvertiert und das Zahlenformat der Zelle wird zurückgesetzt.
