...
| :- | :- | :- |
| url | str | die URL/der Pfad der XML-Datei.|
...
Der folgende Code importiert XML-Daten in das Arbeitsblatt „Blatt 1“ bei Cell A1.
...
| Parameter| Typ| Beschreibung|
| :- | :- | :- |
| stream | io.RawIOBase | der XML-Dateistream.|
| sheet_name | str | der Name des Zielblatts.|
| row | int | die Zielzeile.|
| col | int | die Zielspalte.|
