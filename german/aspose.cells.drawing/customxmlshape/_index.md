...
type: docs
weight: 150
url: /de/aspose.cells.drawing/customxmlshape/
is_root: false
---
...
| [format](/cells/python-net/de/aspose.cells.drawing/customxmlshape/format) | Stellt die Einstellung der Formatierung der Form dar.|
...
| [soft_edges](/cells/python-net/de/aspose.cells.drawing/customxmlshape/soft_edges) | Ruft den auf die Kanten anzuwendenden Weichzeichnungsradius in Punkteinheiten ab und legt diesen fest.|
...
| [is_lock_aspect_ratio](/cells/python-net/de/aspose.cells.drawing/customxmlshape/is_lock_aspect_ratio) | True bedeutet, dass Änderungen des Seitenverhältnisses nicht zulässig sind.|
| [rotation_angle](/cells/python-net/de/aspose.cells.drawing/customxmlshape/rotation_angle) | Ruft die Rotation der Form ab und legt diese fest.|
...
| [spid](/cells/python-net/de/aspose.cells.drawing/customxmlshape/spid) | Gibt eine optionale Zeichenfolge an, die eine Anwendung verwenden kann, um die bestimmte Form zu identifizieren.|
...
| [is_group](/cells/python-net/de/aspose.cells.drawing/customxmlshape/is_group) | Gibt an, ob das Shape eine Gruppe ist.|
...
| [is_locked](/cells/python-net/de/aspose.cells.drawing/customxmlshape/is_locked) | True, wenn das Objekt gesperrt ist, False, wenn das Objekt geändert werden kann, wenn das Blatt geschützt ist.|
...
| [anchor_type](/cells/python-net/de/aspose.cells.drawing/customxmlshape/anchor_type) | Ruft den Formankerplatzhalter ab und legt ihn fest.|
| [placement](/cells/python-net/de/aspose.cells.drawing/customxmlshape/placement) | Stellt die Art und Weise dar, wie das Zeichnungsobjekt an die darunter liegenden Zellen angehängt ist.<br/> Die Eigenschaft steuert die Platzierung eines Objekts auf einem Arbeitsblatt.|
| [upper_left_row](/cells/python-net/de/aspose.cells.drawing/customxmlshape/upper_left_row) | Repräsentiert den Zeilenindex der oberen linken Ecke.|
| [upper_delta_y](/cells/python-net/de/aspose.cells.drawing/customxmlshape/upper_delta_y) | Ruft den vertikalen Versatz des Shapes von seiner oberen linken Eckzeile ab oder legt diesen fest.|
| [upper_left_column](/cells/python-net/de/aspose.cells.drawing/customxmlshape/upper_left_column) | Repräsentiert den Spaltenindex der oberen linken Ecke.|
| [upper_delta_x](/cells/python-net/de/aspose.cells.drawing/customxmlshape/upper_delta_x) | Ruft den horizontalen Versatz des Shapes von seiner oberen linken Eckspalte ab oder legt diesen fest.|
| [lower_right_row](/cells/python-net/de/aspose.cells.drawing/customxmlshape/lower_right_row) | Repräsentiert den Zeilenindex der unteren rechten Ecke.|
| [lower_delta_y](/cells/python-net/de/aspose.cells.drawing/customxmlshape/lower_delta_y) | Ruft den vertikalen Versatz des Shapes von seiner unteren rechten Eckzeile ab oder legt diesen fest.|
| [lower_right_column](/cells/python-net/de/aspose.cells.drawing/customxmlshape/lower_right_column) | Repräsentiert den Spaltenindex der unteren rechten Ecke.|
| [lower_delta_x](/cells/python-net/de/aspose.cells.drawing/customxmlshape/lower_delta_x) | Ruft den horizontalen Versatz des Shapes von seiner unteren rechten Eckspalte ab oder legt diesen fest.|
| [right](/cells/python-net/de/aspose.cells.drawing/customxmlshape/right) | Repräsentiert die Breite des horizontalen Versatzes der Form von ihrer unteren rechten Eckspalte in Pixeleinheiten.|
| [bottom](/cells/python-net/de/aspose.cells.drawing/customxmlshape/bottom) |Repräsentiert die Breite des vertikalen Versatzes der Form von ihrer unteren unteren Eckreihe in Pixeleinheiten.|
| [width](/cells/python-net/de/aspose.cells.drawing/customxmlshape/width) | Stellt die Breite der Form in Pixeleinheiten dar.|
...
| [left_inch](/cells/python-net/de/aspose.cells.drawing/customxmlshape/left_inch) | Stellt den horizontalen Versatz der Form von der linken Spalte in Zoll dar.|
| [left_cm](/cells/python-net/de/aspose.cells.drawing/customxmlshape/left_cm) | Stellt den horizontalen Versatz der Form von der linken Spalte in Zentimetern dar.|
| [top](/cells/python-net/de/aspose.cells.drawing/customxmlshape/top) | Stellt den vertikalen Versatz der Form von der obersten Zeile in Pixeleinheiten dar.|
| [top_inch](/cells/python-net/de/aspose.cells.drawing/customxmlshape/top_inch) |Stellt den vertikalen Versatz der Form von der obersten Reihe in Zoll dar.|
| [top_cm](/cells/python-net/de/aspose.cells.drawing/customxmlshape/top_cm) | Stellt den vertikalen Versatz der Form von der oberen Reihe in Zentimetern dar.|
| [top_to_corner](/cells/python-net/de/aspose.cells.drawing/customxmlshape/top_to_corner) | Ruft den vertikalen Versatz der Form vom oberen Rand des Arbeitsblatts in Pixeleinheiten ab und legt diesen fest.|
...
| [width_scale](/cells/python-net/de/aspose.cells.drawing/customxmlshape/width_scale) | Ruft die Breitenskalierung in Prozent der ursprünglichen Bildbreite ab und legt sie fest.<br/> Wenn die Form nicht picture ist, gibt die Eigenschaft WidthScale nur 100 zurück;|
...
| [has_line](/cells/python-net/de/aspose.cells.drawing/customxmlshape/has_line) | Ruft ab und legt fest, dass der Linienrahmen der Form sichtbar ist.|
...
| [linked_cell](/cells/python-net/de/aspose.cells.drawing/customxmlshape/linked_cell) | Ruft den Arbeitsblattbereich ab, der mit dem Wert des Steuerelements verknüpft ist, oder legt diesen fest.|
...
| [text_orientation_type](/cells/python-net/de/aspose.cells.drawing/customxmlshape/text_orientation_type) | Ruft den Textausrichtungstyp der Form ab und legt diesen fest.|
...
| :- | :- |
| [to_image(stream, image_type)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/to_image/#io.RawIOBase-ImageType) | Erstellt das Formbild und speichert es im angegebenen Format in einem Stream.|
| [to_image(image_file, options)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Speichert die Form in einer Datei.|
| [to_image(stream, options)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) | Speichert die Form in einem Stream.|
| [format_characters(start_index, length, font, flag)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/format_characters/#int-int-Font-StyleFlag) | Formatiert einige Zeichen mit der Schriftarteinstellung.|
| [format_characters(start_index, length, font)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/format_characters/#int-int-Font) | Formatiert einige Zeichen mit der Schriftarteinstellung.|
| [get_result_of_smart_art()](/cells/python-net/de/aspose.cells.drawing/customxmlshape/get_result_of_smart_art/#) | Konvertieren von intelligenter Kunst in gruppierte Formen.|
| [to_front_or_back(orders)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/to_front_or_back/#int) | Bringt die Form nach vorne oder stellt die Form nach hinten.|
| [get_locked_property(type)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/get_locked_property/#ShapeLockType) | Ruft den Wert der gesperrten Eigenschaft ab.|
| [set_locked_property(type, value)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/set_locked_property/#ShapeLockType-bool) | Legen Sie die gesperrte Eigenschaft fest.|
| [add_hyperlink(address)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/add_hyperlink/#str) | Fügt der Form einen Hyperlink hinzu.|
...
| [move_to_range(upper_left_row, upper_left_column, lower_right_row, lower_right_column)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/move_to_range/#int-int-int-int) | Verschiebt die Form in einen angegebenen Bereich.|
| [align_top_right_corner(top_row, right_column)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/align_top_right_corner/#int-int) |Verschiebt das Bild in die obere rechte Ecke.|
...
| [get_linked_cell(is_r1c1, is_local)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/get_linked_cell/#bool-bool) | Ruft den Bereich ab, der mit dem Wert des Steuerelements verknüpft ist.|
| [set_linked_cell(formula, is_r1c1, is_local)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/set_linked_cell/#str-bool-bool) | Legt den Bereich fest, der mit dem Wert des Steuerelements verknüpft ist.|
| [get_input_range(is_r1c1, is_local)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/get_input_range/#bool-bool) | Ruft den Bereich ab, der zum Füllen des Steuerelements verwendet wird.|
| [set_input_range(formula, is_r1c1, is_local)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/set_input_range/#str-bool-bool) | Legt den Bereich fest, der zum Füllen des Steuerelements verwendet wird.|
...
| [characters(start_index, length)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/characters/#int-int) | Gibt ein Characters-Objekt zurück, das einen Bereich von Zeichen im Text darstellt.|
...
| [is_same_setting(obj)](/cells/python-net/de/aspose.cells.drawing/customxmlshape/is_same_setting/#any) | Gibt zurück, ob die Form gleich ist.|
