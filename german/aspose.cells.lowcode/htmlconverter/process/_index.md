...
type: docs
weight: 20
url: /de/aspose.cells.lowcode/htmlconverter/process/
is_root: false
---
##  process(, Vorlagendatei, Ergebnisdatei){#str-str}
Konvertiert die angegebene Vorlagendatei zwischen HTML und anderen Formaten.
...
Konvertiert Dateien zwischen HTML und anderen Tabellenkalkulationsdateiformaten.
...
* Klasse [`HtmlConverter`](/cells/python-net/de/aspose.cells.lowcode/htmlconverter)
