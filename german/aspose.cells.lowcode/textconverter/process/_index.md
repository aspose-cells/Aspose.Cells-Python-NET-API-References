...
type: docs
weight: 20
url: /de/aspose.cells.lowcode/textconverter/process/
is_root: false
---
##  process(, Vorlagendatei, Ergebnisdatei){#str-str}
Konvertiert die angegebene Vorlagendatei zwischen textbasierten Dateien und anderen Formaten.
...
| :- | :- | :- |
| template_file | str | Die zu konvertierende Vorlagendatei|
...
Konvertiert Dateiformate zwischen textbasierten Formaten und anderen Tabellenkalkulationsdateiformaten
...
* Klasse [`TextConverter`](/cells/python-net/de/aspose.cells.lowcode/textconverter)
