---
title: inner_y_ratio_to_chart Eigentum
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 280
url: /de/aspose.cells.charts/plotarea/inner_y_ratio_to_chart/
is_root: false
---
##  inner_y_ratio_to_chart Eigentum

Ruft die x-Koordinate der oberen Ecke des Zeichnungsbereichs in Einheiten des Verhältnisses zum Diagrammbereich ab.
