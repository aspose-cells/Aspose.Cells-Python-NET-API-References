...
type: docs
weight: 380
url: /de/aspose.cells.charts/plotarea/width_ratio_to_chart/
is_root: false
---
##  width_ratio_to_chart Eigentum

Ruft die Breite des Begrenzungsrahmens des Plotbereichs in Einheiten des Verhältnisses des Diagrammbereichs ab oder legt diese fest.
...
BreitePixel = BreitenverhältnisZumDiagramm * chart.ChartObject.Width.
###  Definition:
```python
@property
