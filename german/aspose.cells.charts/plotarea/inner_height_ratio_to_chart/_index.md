---
title: inner_height_ratio_to_chart Eigentum
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 220
url: /de/aspose.cells.charts/plotarea/inner_height_ratio_to_chart/
is_root: false
---
##  inner_height_ratio_to_chart Eigentum

Ruft die Höhe des Zeichnungsbereichs in Einheiten des Verhältnisses zum Diagrammbereich ab oder legt sie fest.
