...
type: docs
weight: 10
url: /de/aspose.cellsgridjs/
is_root: false
---
 Der**Aspose.Cells.GridJs** Der Namespace enthält alle Klassen von GridJs, die grundlegende Operationen zum Verwalten von Tabellenkalkulationen bereitstellen, ohne Microsoft Excel zu verwenden.
...
| :- | :- |
| [`GridExceptionType`](/cells/python-net/de/aspose.cellsgridjs/gridexceptiontype) | Stellt benutzerdefinierten Ausnahmecode für GridJs dar.|
| [`GridLoadFormat`](/cells/python-net/de/aspose.cellsgridjs/gridloadformat) | Stellt das Ladedateiformat dar.|
