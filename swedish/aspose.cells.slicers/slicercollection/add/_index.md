...
Lägg till en ny utskärare med hjälp av pivottabell som datakälla


###  Returnerar

Det nya add-slicerindexet
...
| dest_cell_name | str | Cellen i det övre vänstra hörnet av utsnittsområdet.|
...
Lägg till en ny utskärare med ListObjet som datakälla
...
| :- | :- | :- |
| table | aspose.cells.tables.ListObject | ListObject-objekt|
| list_column | aspose.cells.tables.ListColumn | ListColumn i ListObject.ListColumns|
| dest_cell_name | str | Cellen i det övre vänstra hörnet av utsnittsområdet.|
...
| :- | :- | :- |
| pivot | aspose.cells.pivot.PivotTable | Pivottabellobjekt|
| row | int | Radindex för cellen i det övre vänstra hörnet av utsnittsområdet.|
| column | int | Kolumnindex för cellen i det övre vänstra hörnet av utsnittsområdet.|
| base_field_name | str | Namnet på PivotField i PivotTable.BaseFields|
