...
| :- | :- |
| [save_format](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/save_format) | Hämtar spara filformatet.|
| [clear_data](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/clear_data) | Gör arbetsboken tom efter att du har sparat filen.|
| [cached_file_folder](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/cached_file_folder) | Den cachade filmappen används för att lagra en del stora data.|
| [validate_merged_areas](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/validate_merged_areas) | Anger om sammanslagna celler ska valideras innan filen sparas.|
...
| [operator_type](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/operator_type) | Hämtar och ställer in operatortypen för sql.|
| [primary_key](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/primary_key) | Representerar vilken kolumn som är primärnyckeln i datatabellen.|
| [create_table](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/create_table) | Anger om sql för att skapa tabell exporteras.|
| [id_name](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/id_name) | Hämtar och ställer in namnet på id-kolumnen.|
| [start_id](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/start_id) | Hämtar och ställer in start-id.|
| [table_name](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/table_name) | Hämtar och ställer in tabellnamnet.|
| [export_as_string](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/export_as_string) | Anger om all data exporteras som strängvärde.|
| [sheet_indexes](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/sheet_indexes) | Representerar indexen för exporterade ark.|
| [export_area](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/export_area) | Hämtar eller ställer in exportintervallet.|
| [has_header_row](/cells/python-net/sv/aspose.cells.saving/sqlscriptsaveoptions/has_header_row) | Anger om intervallet innehåller rubrikrad.|
