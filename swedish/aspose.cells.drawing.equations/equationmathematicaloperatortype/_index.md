---
title: EquationMathematicalOperatorType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 260
url: /sv/aspose.cells.drawing.equations/equationmathematicaloperatortype/
is_root: false
---
##  EquationMathematicalOperatorType uppräkning
Typ av matematiska operatorer



Typen EquationMathematicalOperatorType avslöjar följande medlemmar:

###  Fält
| Fält| Beskrivning|
| :- | :- |
| UNKNOWN | Använd okänd typ om den inte finns i en befintlig typ.|
| FOR_ALL | "∀" Unicode:\u2200|
| COMPLEMENT | "∁" Unicode:\u2201|
