...
type: docs
weight: 20
url: /sv/aspose.cells.lowcode/htmlconverter/process/
is_root: false
---
##  process(, mallfil, resultatfil){#str-str}
Konverterar given mallfil mellan html och andra format.
...
| :- | :- | :- |
| template_file | str | Mallfilen som ska konverteras|
...
Konverterar filer mellan html och andra kalkylbladsfilformat.
...
* klass [`HtmlConverter`](/cells/python-net/sv/aspose.cells.lowcode/htmlconverter)
