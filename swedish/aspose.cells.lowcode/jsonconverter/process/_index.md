...
type: docs
weight: 20
url: /sv/aspose.cells.lowcode/jsonconverter/process/
is_root: false
---
##  process(, mallfil, resultatfil){#str-str}
Konverterar given mallfil mellan json och andra format.
...
Konverterar mellan json-data och andra kalkylbladsfilformat.
...
* klass [`JsonConverter`](/cells/python-net/sv/aspose.cells.lowcode/jsonconverter)
