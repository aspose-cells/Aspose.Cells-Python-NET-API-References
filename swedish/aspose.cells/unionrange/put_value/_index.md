...
type: docs
weight: 60
url: /sv/aspose.cells/unionrange/put_value/
is_root: false
---
##  put_value(self, string_value, is_converted, set_style) {#str-bool-bool}
Lägger in ett värde i intervallet. Om lämpligt konverteras värdet till en annan datatyp och cellens talformat återställs.
