...
| Metod| Beskrivning|
| :- | :- |
| [get_formula1(is_r1c1, is_local)](/cells/python-net/sv/aspose.cells/formatcondition/get_formula1/#bool-bool) | Hämtar värdet eller uttrycket som är kopplat till detta formatvillkor.|
| [get_formula1(is_r1c1, is_local, row, column)](/cells/python-net/sv/aspose.cells/formatcondition/get_formula1/#bool-bool-int-int) | Hämtar värdet eller uttrycket för den villkorliga formateringen av cellen.|
| [get_formula1(row, column)](/cells/python-net/sv/aspose.cells/formatcondition/get_formula1/#int-int) | Hämtar formeln för den villkorliga formateringen av cellen.|
| [get_formula2(is_r1c1, is_local)](/cells/python-net/sv/aspose.cells/formatcondition/get_formula2/#bool-bool) | Hämtar värdet eller uttrycket som är kopplat till detta formatvillkor.|
| [get_formula2(is_r1c1, is_local, row, column)](/cells/python-net/sv/aspose.cells/formatcondition/get_formula2/#bool-bool-int-int) | Hämtar värdet eller uttrycket för den villkorliga formateringen av cellen.|
| [get_formula2(row, column)](/cells/python-net/sv/aspose.cells/formatcondition/get_formula2/#int-int) | Hämtar formeln för den villkorliga formateringen av cellen.|
| [set_formulas(formula1, formula2, is_r1c1, is_local)](/cells/python-net/sv/aspose.cells/formatcondition/set_formulas/#str-str-bool-bool) | Ställer in värdet eller uttrycket som är associerat med detta formatvillkor.|
| [set_formula1(formula, is_r1c1, is_local)](/cells/python-net/sv/aspose.cells/formatcondition/set_formula1/#str-bool-bool) | Ställer in värdet eller uttrycket som är associerat med detta formatvillkor.|
| [set_formula2(formula, is_r1c1, is_local)](/cells/python-net/sv/aspose.cells/formatcondition/set_formula2/#str-bool-bool) | Ställer in värdet eller uttrycket som är associerat med detta formatvillkor.|
