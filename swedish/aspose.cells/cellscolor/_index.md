...
| :- | :- |
| [is_shape_color](/cells/python-net/sv/aspose.cells/cellscolor/is_shape_color) | Hämtar och ställer in färgen som ska gälla för cell eller form.|
| [type](/cells/python-net/sv/aspose.cells/cellscolor/type) | Färgtypen.|
| [theme_color](/cells/python-net/sv/aspose.cells/cellscolor/theme_color) | Får temafärgen. Gäller endast för temafärgstyp.|
