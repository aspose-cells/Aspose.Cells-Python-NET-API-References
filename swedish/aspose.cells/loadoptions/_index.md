...
| :- | :- |
| [__init__](/cells/python-net/sv/aspose.cells/loadoptions/__init__/#) | Skapar ett alternativ för att ladda filen.|
| [__init__](/cells/python-net/sv/aspose.cells/loadoptions/__init__/#aspose.cells.LoadFormat) | Skapar ett alternativ för att ladda filen.|
...
| [ignore_useless_shapes](/cells/python-net/sv/aspose.cells/loadoptions/ignore_useless_shapes) | Anger om värdelösa former ignoreras.|
| [preserve_padding_spaces_in_formula](/cells/python-net/sv/aspose.cells/loadoptions/preserve_padding_spaces_in_formula) | Anger om de mellanslag och radbrytningar som är utfyllda mellan formeltokens bevaras<br/>samtidigt som du hämtar och ställer in formler.<br/> Standardvärdet är falskt.|


###  Metoder
| Metod| Beskrivning|
| :- | :- |
| [set_paper_size](/cells/python-net/sv/aspose.cells/loadoptions/set_paper_size/#aspose.cells.PaperSizeType) | Ställer in standardstorleken för utskriftspapper från standardskrivarens inställning.|
