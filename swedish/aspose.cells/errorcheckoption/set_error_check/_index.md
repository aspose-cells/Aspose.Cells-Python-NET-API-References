...
type: docs
weight: 70
url: /sv/aspose.cells/errorcheckoption/set_error_check/
is_root: false
---
##  set_error_check(self, error_check_type, is_check) {#aspose.cells.ErrorCheckType-bool}
Anger om en given feltyp ska kontrolleras.
...
| is_check | bool | sant om den givna feltypen behöver kontrolleras (grön triangel visas för cellen om kontrollen misslyckades).|
