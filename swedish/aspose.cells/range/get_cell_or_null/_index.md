...
type: docs
weight: 150
url: /sv/aspose.cells/range/get_cell_or_null/
is_root: false
---
##  get_cell_or_null(self, row_offset, column_offset) {#int-int}
Hämtar [`Cell`](/cells/python-net/sv/aspose.cells/cell)-objektet eller null i detta intervall.


###  Returnerar

[`Cell`](/cells/python-net/sv/aspose.cells/cell)-objekt.
