...
| :- | :- |
| [OdsLoadOptions()](/cells/python-net/sv/aspose.cells/odsloadoptions/__init__/#) | Representerar alternativen för att ladda ods-filen.|
| [OdsLoadOptions(type)](/cells/python-net/sv/aspose.cells/odsloadoptions/__init__/#LoadFormat) | Representerar alternativen för att ladda ods-filen.|
...
| Metod| Beskrivning|
| :- | :- |
| [set_paper_size(type)](/cells/python-net/sv/aspose.cells/odsloadoptions/set_paper_size/#PaperSizeType) | Ställer in standardstorleken för utskriftspapper från standardskrivarens inställning.|
