...
| :- | :- |
| [HtmlLoadOptions()](/cells/python-net/sv/aspose.cells/htmlloadoptions/__init__/#) | Skapar ett alternativ för att ladda filen.|
| [HtmlLoadOptions(load_format)](/cells/python-net/sv/aspose.cells/htmlloadoptions/__init__/#LoadFormat) | Skapar ett alternativ för att ladda filen.|
...
| [support_div_tag](/cells/python-net/sv/aspose.cells/htmlloadoptions/support_div_tag) | Anger om stöd för layouten av<div> taggen när html-filen innehåller<div> taggar. Standardvärdet är falskt.|
| [delete_redundant_spaces](/cells/python-net/sv/aspose.cells/htmlloadoptions/delete_redundant_spaces) | Indikerar om redundanta blanksteg ska raderas när texten radbryts med hjälp av<br> tag. Standardvärdet är false.|
...
| Metod| Beskrivning|
| :- | :- |
| [set_paper_size(type)](/cells/python-net/sv/aspose.cells/htmlloadoptions/set_paper_size/#PaperSizeType) | Ställer in standardstorleken för utskriftspapper från standardskrivarens inställning.|
