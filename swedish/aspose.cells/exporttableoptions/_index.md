...
| :- | :- |
| [__init__](/cells/python-net/sv/aspose.cells/exporttableoptions/__init__/#) | Konstruerar en ny instans av ExportTableOptions|
...
| [allow_db_null](/cells/python-net/sv/aspose.cells/exporttableoptions/allow_db_null) | Detta värde indikerar om DBNulls är tillåtna i den här tabellen.|
...
| Metod| Beskrivning|
| :- | :- |
| [preprocess_exported_value](/cells/python-net/sv/aspose.cells/exporttableoptions/preprocess_exported_value/#int-int-aspose.cells.CellValue) | Förbearbeta värdet för den aktuella cellen som ska exporteras.|



###  Anmärkningar

Om det finns några speciella krav på exporten, som att ignorera felvärden, kan användaren utöka denna klass
att skriva över motsvarande api för att nå målet.
