...
| :- | :- |
| [HtmlSaveOptions()](/cells/python-net/sv/aspose.cells/htmlsaveoptions/__init__/#) | Skapar alternativ för att spara html-fil.|
| [HtmlSaveOptions(format)](/cells/python-net/sv/aspose.cells/htmlsaveoptions/__init__/#SaveFormat) | Skapar alternativ för att spara htm-fil.|
...
| [width_scalable](/cells/python-net/sv/aspose.cells/htmlsaveoptions/width_scalable) |Anger om skalbar enhet används för att beskriva kolumnbredden vid export av fil till html.<br/> Standardvärdet är falskt.|
...
| [export_active_worksheet_only](/cells/python-net/sv/aspose.cells/htmlsaveoptions/export_active_worksheet_only) | Indikerar om hela arbetsboken exporteras till html-fil.|
...
| [parse_html_tag_in_cell](/cells/python-net/sv/aspose.cells/htmlsaveoptions/parse_html_tag_in_cell) | Analysera HTML-tagg i cell, som ,som cellvärde eller som HTML-tagg, standard är sant|
...
| [link_target_type](/cells/python-net/sv/aspose.cells/htmlsaveoptions/link_target_type) | Anger typen av målattribut i<a> länk, Standardvärdet är HtmlLinkTargetType.Parent.|
