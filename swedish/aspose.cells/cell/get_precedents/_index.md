...
Samling av alla referenser som visas i den här cellens formel.
...
* Returnerar null om detta inte är en formelcell. Alla referenser som visas i den här cellens formel returneras oavsett om de refereras till eller inte under beräkningen.

Till exempel, även om cell A2 i formeln "=OM(SANT;A1;A2)" inte används vid beräkning,
den används fortfarande som formelns prejudikat. För att få de referenser som endast påverkar beräkningen, använd [`Cell.get_precedents_in_calculation`](/cells/python-net/sv/aspose.cells/cell/get_precedents_in_calculation).
