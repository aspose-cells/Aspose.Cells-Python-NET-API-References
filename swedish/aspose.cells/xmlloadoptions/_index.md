...
| :- | :- |
| [XmlLoadOptions()](/cells/python-net/sv/aspose.cells/xmlloadoptions/__init__/#) | Representerar alternativen för att ladda xml-fil.|
| [XmlLoadOptions(type)](/cells/python-net/sv/aspose.cells/xmlloadoptions/__init__/#LoadFormat) | Representerar alternativen för att ladda xml-fil.|
...
| Metod| Beskrivning|
| :- | :- |
| [set_paper_size(type)](/cells/python-net/sv/aspose.cells/xmlloadoptions/set_paper_size/#PaperSizeType) | Ställer in standardstorleken för utskriftspapper från standardskrivarens inställning.|
