...
| :- | :- |
| [author](/cells/python-net/sv/aspose.cells/comment/author) | Hämtar och sätter Namn på den ursprungliga kommentarsförfattaren|
| [comment_shape](/cells/python-net/sv/aspose.cells/comment/comment_shape) | Skaffa ett Shape-objekt som representerar formen som är kopplad till den angivna kommentaren.|
| [row](/cells/python-net/sv/aspose.cells/comment/row) | Hämtar radindex för kommentaren.|
| [column](/cells/python-net/sv/aspose.cells/comment/column) | Hämtar kolumnindex för kommentaren.|
| [is_threaded_comment](/cells/python-net/sv/aspose.cells/comment/is_threaded_comment) | Anger om denna kommentar är en trådad kommentar.|
...
| [height](/cells/python-net/sv/aspose.cells/comment/height) | Representerar höjden på kommentaren, i pixelenhet.|
| [width_inch](/cells/python-net/sv/aspose.cells/comment/width_inch) | Representerar bredden på kommentaren, i enhet av tum.|
| [height_inch](/cells/python-net/sv/aspose.cells/comment/height_inch) | Representerar höjden på kommentaren, i enhet av tum.|
