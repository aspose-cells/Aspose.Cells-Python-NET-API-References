...
| :- | :- |
| [save_format](/cells/python-net/sv/aspose.cells/jsonsaveoptions/save_format) | Hämtar spara filformatet.|
| [clear_data](/cells/python-net/sv/aspose.cells/jsonsaveoptions/clear_data) | Gör arbetsboken tom efter att du har sparat filen.|
| [cached_file_folder](/cells/python-net/sv/aspose.cells/jsonsaveoptions/cached_file_folder) | Den cachade filmappen används för att lagra en del stora data.|
| [validate_merged_areas](/cells/python-net/sv/aspose.cells/jsonsaveoptions/validate_merged_areas) | Anger om sammanslagna celler ska valideras innan filen sparas.|
...
| [export_hyperlink_type](/cells/python-net/sv/aspose.cells/jsonsaveoptions/export_hyperlink_type) | Representerar typen av exporterande hyperlänk till json.|
| [skip_empty_rows](/cells/python-net/sv/aspose.cells/jsonsaveoptions/skip_empty_rows) | Anger om tomma rader hoppar över.|
| [sheet_indexes](/cells/python-net/sv/aspose.cells/jsonsaveoptions/sheet_indexes) | Representerar indexen för exporterade ark.|
| [export_area](/cells/python-net/sv/aspose.cells/jsonsaveoptions/export_area) | Hämtar eller ställer in exportintervallet.|
