...
| :- | :- |
| [calculated_value](/cells/python-net/sv/aspose.cells/calculationdata/calculated_value) | Hämtar eller ställer in det beräknade värdet för denna funktion.|
| [workbook](/cells/python-net/sv/aspose.cells/calculationdata/workbook) | Hämtar Workbook-objektet där funktionen finns i.|
