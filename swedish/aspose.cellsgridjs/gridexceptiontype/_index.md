---
title: GridExceptionType uppräkning
second_title: Aspose.Cells.GridJs for Python via .NET API Referenser
description:
type: docs
weight: 90
url: /sv/aspose.cellsgridjs/gridexceptiontype/
is_root: false
---
##  GridExceptionType uppräkning
Representerar anpassad undantagskod för GridJs.



Typen GridExceptionType avslöjar följande medlemmar:
