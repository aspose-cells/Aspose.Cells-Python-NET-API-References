...
type: docs
weight: 10
url: /sv/aspose.cellsgridjs/
is_root: false
---
 De**Aspose.Cells.GridJs** namnrymden innehåller alla klasser av GridJs som tillhandahåller grundläggande funktioner för att hantera kalkylblad utan att använda Microsoft Excel.
...
| :- | :- |
| [`GridExceptionType`](/cells/python-net/sv/aspose.cellsgridjs/gridexceptiontype) | Representerar anpassad undantagskod för GridJs.|
| [`GridLoadFormat`](/cells/python-net/sv/aspose.cellsgridjs/gridloadformat) | Representerar laddningsfilformatet.|
