---
title: GridCacheForStream klass
second_title: Aspose.Cells.GridJs for Python via .NET API Referenser
description:
type: docs
weight: 30
url: /sv/aspose.cellsgridjs/gridcacheforstream/
is_root: false
---
##  GridCacheForStream klass

Den här klassen innehåller cache-operationerna för GridJs. Användaren ska implementera sin egen affärslogik för lagring baserad på den..



Typen GridCacheForStream avslöjar följande medlemmar:
