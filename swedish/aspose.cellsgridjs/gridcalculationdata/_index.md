---
title: GridCalculationData klass
second_title: Aspose.Cells.GridJs for Python via .NET API Referenser
description:
type: docs
weight: 40
url: /sv/aspose.cellsgridjs/gridcalculationdata/
is_root: false
---
##  GridCalculationData klass

Representerar de data som krävs vid beräkning av en funktion, såsom funktionsnamn, parametrar, ... etc.



Typen GridCalculationData avslöjar följande medlemmar:

###  Egenskaper
| Fast egendom| Beskrivning|
| :- | :- |
| [calculated_value](/cells/python-net/sv/aspose.cellsgridjs/gridcalculationdata/calculated_value) | Hämtar/ställer in det beräknade värdet för denna funktion.|
| [row](/cells/python-net/sv/aspose.cellsgridjs/gridcalculationdata/row) | Hämtar Cell radindex där funktionen finns.|
