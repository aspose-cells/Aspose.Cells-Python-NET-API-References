...
| :- | :- |
| [__init__](/cells/python-net/sv/aspose.cells.rendering/imageorprintoptions/__init__/#) | Konstruerar en ny instans av ImageOrPrintOptions|
...
| [emf_render_setting](/cells/python-net/sv/aspose.cells.rendering/imageorprintoptions/emf_render_setting) | Inställning för rendering av Emf-metafil.|


###  Metoder
| Metod| Beskrivning|
| :- | :- |
| [set_desired_size](/cells/python-net/sv/aspose.cells.rendering/imageorprintoptions/set_desired_size/#int-int) | Ställer in önskad bredd och höjd på bilden.|
| [set_desired_size](/cells/python-net/sv/aspose.cells.rendering/imageorprintoptions/set_desired_size/#int-int-bool) | Ställer in önskad bredd och höjd på bilden.|
