---
title: inner_width_ratio_to_chart fastighet
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 240
url: /sv/aspose.cells.charts/plotarea/inner_width_ratio_to_chart/
is_root: false
---
##  inner_width_ratio_to_chart fastighet

Hämtar eller ställer in bredden på plottarean i enheter som motsvarar diagramarean.
...
InnerWidth i Pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Definition:
```python
@property
