---
title: inner_height_ratio_to_chart fastighet
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 220
url: /sv/aspose.cells.charts/plotarea/inner_height_ratio_to_chart/
is_root: false
---
##  inner_height_ratio_to_chart fastighet

Hämtar eller ställer in höjden på plottarean i enheter som motsvarar diagramarean.
...
InnerHeight i Pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Definition:
```python
@property
