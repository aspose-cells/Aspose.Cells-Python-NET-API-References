---
title: inner_x_ratio_to_chart fastighet
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 260
url: /sv/aspose.cells.charts/plotarea/inner_x_ratio_to_chart/
is_root: false
---
##  inner_x_ratio_to_chart fastighet
...
InnerX i Pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Definition:
```python
@property
