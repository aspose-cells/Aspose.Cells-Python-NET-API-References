...
| [number](/cells/python-net/sv/aspose.cells.pivot/pivotfield/number) | Representerar det inbyggda visningsformatet för siffror och datum.|
...
| [show_compact](/cells/python-net/sv/aspose.cells.pivot/pivotfield/show_compact) | Anger om etiketter från nästa fält i samma kolumn visas i pivottabellvyn|
