...
Lägger till fältet i det specifika området.


###  Returnerar

Fältpositionen i de specifika fälten. Om det inte finns något fält med samma namn, returnera -1.
...
| :- | :- | :- |
| field_type | [`PivotFieldType`](/cells/python-net/sv/aspose.cells.pivot/pivotfieldtype) | Fältområdets typ.|
