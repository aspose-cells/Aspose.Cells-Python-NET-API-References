...
| [refresh_data_flag](/cells/python-net/sv/aspose.cells.pivot/pivottable/refresh_data_flag) | Indikerar om Uppdatera data eller inte.|
...
| Metod| Beskrivning|
| :- | :- |
| [remove_field(field_type, field_name)](/cells/python-net/sv/aspose.cells.pivot/pivottable/remove_field/#PivotFieldType-str) | Tar bort ett fält från ett specifikt fältområde|
| [remove_field(field_type, base_field_index)](/cells/python-net/sv/aspose.cells.pivot/pivottable/remove_field/#PivotFieldType-int) | Tar bort ett fält från ett specifikt fältområde|
| [remove_field(field_type, pivot_field)](/cells/python-net/sv/aspose.cells.pivot/pivottable/remove_field/#PivotFieldType-PivotField) | Ta bort fält från specifikt fältområde|
| [add_field_to_area(field_type, field_name)](/cells/python-net/sv/aspose.cells.pivot/pivottable/add_field_to_area/#PivotFieldType-str) | Lägger till fältet till det specifika området.|
| [add_field_to_area(field_type, base_field_index)](/cells/python-net/sv/aspose.cells.pivot/pivottable/add_field_to_area/#PivotFieldType-int) | Lägger till fältet till det specifika området.|
| [add_field_to_area(field_type, pivot_field)](/cells/python-net/sv/aspose.cells.pivot/pivottable/add_field_to_area/#PivotFieldType-PivotField) | Lägger till fältet till det specifika området.|
| [add_calculated_field(name, formula, drag_to_data_area)](/cells/python-net/sv/aspose.cells.pivot/pivottable/add_calculated_field/#str-str-bool) | Lägger till ett beräknat fält till pivotfält.|
| [add_calculated_field(name, formula)](/cells/python-net/sv/aspose.cells.pivot/pivottable/add_calculated_field/#str-str) | Lägger till ett beräknat fält till pivotfältet och dra det till dataområdet.|
| [move(row, column)](/cells/python-net/sv/aspose.cells.pivot/pivottable/move/#int-int) | Flyttar pivottabellen till en annan plats i kalkylbladet.|
| [move(dest_cell_name)](/cells/python-net/sv/aspose.cells.pivot/pivottable/move/#str) | Flyttar pivottabellen till en annan plats i kalkylbladet.|
| [set_auto_group_field(base_field_index)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_auto_group_field/#int) | Ställer in automatisk fältgrupp efter pivottabellen.|
| [set_auto_group_field(pivot_field)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_auto_group_field/#PivotField) | Ställer in automatisk fältgrupp efter pivottabellen.|
| [set_manual_group_field(base_field_index, start_val, end_val, group_by_list, interval_num)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_manual_group_field/#int-float-float-list-float) | Ställer in manuell fältgrupp efter pivottabellen.|
| [set_manual_group_field(pivot_field, start_val, end_val, group_by_list, interval_num)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_manual_group_field/#PivotField-float-float-list-float) | Ställer in manuell fältgrupp efter pivottabellen.|
| [set_manual_group_field(base_field_index, start_val, end_val, group_by_list, interval_num)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_manual_group_field/#int-DateTime-DateTime-list-int) | Ställer in manuell fältgrupp efter pivottabellen.|
| [set_manual_group_field(pivot_field, start_val, end_val, group_by_list, interval_num)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_manual_group_field/#PivotField-DateTime-DateTime-list-int) | Ställer in manuell fältgrupp efter pivottabellen.|
| [set_ungroup(base_field_index)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_ungroup/#int) | Anger att gruppera efter pivottabellen|
| [set_ungroup(pivot_field)](/cells/python-net/sv/aspose.cells.pivot/pivottable/set_ungroup/#PivotField) | Anger att gruppera efter pivottabellen|
| [copy_style(pivot_table)](/cells/python-net/sv/aspose.cells.pivot/pivottable/copy_style/#PivotTable) | Kopierar namngiven stil från en annan pivottabell.|
| [show_report_filter_page(page_field)](/cells/python-net/sv/aspose.cells.pivot/pivottable/show_report_filter_page/#PivotField) | Visa alla rapportfiltersidor enligt PivotField, PivotField måste finnas i PageFields.|
| [show_report_filter_page_by_name(field_name)](/cells/python-net/sv/aspose.cells.pivot/pivottable/show_report_filter_page_by_name/#str) | Visa alla rapportfiltersidor enligt PivotFields namn, PivotField måste finnas i PageFields.|
| [show_report_filter_page_by_index(pos_index)](/cells/python-net/sv/aspose.cells.pivot/pivottable/show_report_filter_page_by_index/#int) |Visa alla rapportfiltersidor enligt positionsindex i sidfälten|
| [fields(field_type)](/cells/python-net/sv/aspose.cells.pivot/pivottable/fields/#PivotFieldType) | Hämtar de specifika fälten efter fälttyp.|
| [change_data_source(source)](/cells/python-net/sv/aspose.cells.pivot/pivottable/change_data_source/#list) | Ställ in pivotables källdata.<br/> Blad1!$A$1:$C$3|
...
| [format_all(style)](/cells/python-net/sv/aspose.cells.pivot/pivottable/format_all/#Style) | Formatera hela cellen i det vridbara området|
| [format_row(row, style)](/cells/python-net/sv/aspose.cells.pivot/pivottable/format_row/#int-Style) | Formatera raddata i det vridbara området|
| [format(row, column, style)](/cells/python-net/sv/aspose.cells.pivot/pivottable/format/#int-int-Style) | Formatera cellen i det vridbara området|
...
| [get_cell_by_display_name(display_name)](/cells/python-net/sv/aspose.cells.pivot/pivottable/get_cell_by_display_name/#str) | Hämtar objektet Cell med visningsnamnet för pivotfältet|
