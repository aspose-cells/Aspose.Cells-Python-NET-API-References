...
type: docs
weight: 450
url: /sv/aspose.cells.drawing/picture/
is_root: false
---
##  Picture klass
...
| :- | :- |
| [macro_name](/cells/python-net/sv/aspose.cells.drawing/picture/macro_name) | Hämtar och ställer in namnet på makrot.|
| [is_equation](/cells/python-net/sv/aspose.cells.drawing/picture/is_equation) | Anger om formen endast innehåller en ekvation.|
...
| [upper_left_column](/cells/python-net/sv/aspose.cells.drawing/picture/upper_left_column) | Representerar kolumnindex i det övre vänstra hörnet.|
| [upper_delta_x](/cells/python-net/sv/aspose.cells.drawing/picture/upper_delta_x) | Hämtar eller ställer in formens horisontella förskjutning från dess övre vänstra hörnspalt.|
| [lower_right_row](/cells/python-net/sv/aspose.cells.drawing/picture/lower_right_row) | Representerar radindex i nedre högra hörnet.|
| [lower_delta_y](/cells/python-net/sv/aspose.cells.drawing/picture/lower_delta_y) | Hämtar eller ställer in formens vertikala förskjutning från dess nedre högra hörnrad.|
...
| [height](/cells/python-net/sv/aspose.cells.drawing/picture/height) | Representerar formhöjden, i pixelenhet.|
| [height_inch](/cells/python-net/sv/aspose.cells.drawing/picture/height_inch) | Representerar höjden på formen, i enhet av tum.|
| [height_pt](/cells/python-net/sv/aspose.cells.drawing/picture/height_pt) | Representerar höjden på formen, i punktenhet.|
| [height_cm](/cells/python-net/sv/aspose.cells.drawing/picture/height_cm) | Representerar höjden på formen, i centimeterenhet.|
| [left](/cells/python-net/sv/aspose.cells.drawing/picture/left) | Representerar den horisontella förskjutningen av formen från dess vänstra kolumn, i enhet av pixlar.|
...
| [y](/cells/python-net/sv/aspose.cells.drawing/picture/y) | Hämtar och ställer in den vertikala förskjutningen av formen från kalkylbladets övre kant, i pixelenhet.|
| [width_scale](/cells/python-net/sv/aspose.cells.drawing/picture/width_scale) | Hämtar och ställer in breddskalan, i procentenhet av den ursprungliga bildens bredd.<br/> Om formen inte är bild, returnerar egenskapen WidthScale endast 100;|
| [height_scale](/cells/python-net/sv/aspose.cells.drawing/picture/height_scale) | Hämtar och ställer in höjdskalan, i procentenhet av den ursprungliga bildhöjden.<br/> Om formen inte är bild, returnerar egenskapen HeightScale endast 100;|
| [top_in_shape](/cells/python-net/sv/aspose.cells.drawing/picture/top_in_shape) | Representerar den vertikala förskjutningen av formen från den övre kanten av den överordnade formen,<br/> i enhet av 1/4000 av höjden på den överordnade formen.|
| [left_in_shape](/cells/python-net/sv/aspose.cells.drawing/picture/left_in_shape) |Representerar den horisontella förskjutningen av formen från den vänstra kanten av den överordnade formen,<br/> i enhet av 1/4000 av bredden av den överordnade formen.|
| [width_in_shape](/cells/python-net/sv/aspose.cells.drawing/picture/width_in_shape) | Representerar formens bredd, i enheten 1/4000 av den överordnade formen.|
| [height_in_shape](/cells/python-net/sv/aspose.cells.drawing/picture/height_in_shape) | Representerar den vertikala förskjutningen av formen från den övre kanten av den överordnade formen, i enhet av 1/4000 av höjden på den överordnade formen.|
| [group](/cells/python-net/sv/aspose.cells.drawing/picture/group) | Hämtar gruppformen som innehåller denna form.|
| [type](/cells/python-net/sv/aspose.cells.drawing/picture/type) | Hämtar den automatiska formtypen.|
| [has_line](/cells/python-net/sv/aspose.cells.drawing/picture/has_line) | Hämtar och ställer in linjekanten för formen är synlig.|
| [is_filled](/cells/python-net/sv/aspose.cells.drawing/picture/is_filled) | Anger om fyllningsformatet är synligt.|
| [is_flipped_horizontally](/cells/python-net/sv/aspose.cells.drawing/picture/is_flipped_horizontally) | Hämtar och ställer in om formen ska vändas horisontellt.|
| [is_flipped_vertically](/cells/python-net/sv/aspose.cells.drawing/picture/is_flipped_vertically) | Hämtar och ställer in om formen vänds vertikalt.|
| [actual_lower_right_row](/cells/python-net/sv/aspose.cells.drawing/picture/actual_lower_right_row) | Få den faktiska nedersta raden.|
| [connection_points](/cells/python-net/sv/aspose.cells.drawing/picture/connection_points) | Skaffa anslutningspunkterna|
| [relative_to_original_picture_size](/cells/python-net/sv/aspose.cells.drawing/picture/relative_to_original_picture_size) | Anger om formen är relativt originalbildstorleken.|
| [linked_cell](/cells/python-net/sv/aspose.cells.drawing/picture/linked_cell) | Hämtar eller ställer in kalkylbladsintervallet kopplat till kontrollens värde.|
| [input_range](/cells/python-net/sv/aspose.cells.drawing/picture/input_range) | Hämtar eller ställer in kalkylbladsintervallet som används för att fylla den angivna kombinationsrutan.|
| [text_shape_type](/cells/python-net/sv/aspose.cells.drawing/picture/text_shape_type) |Hämtar och ställer in den förinställda textformen.|
| [text_body](/cells/python-net/sv/aspose.cells.drawing/picture/text_body) | Hämtar och ställer in inställningen för formens text.|
| [font](/cells/python-net/sv/aspose.cells.drawing/picture/font) | Representerar formens teckensnitt.|
| [text_options](/cells/python-net/sv/aspose.cells.drawing/picture/text_options) | Representerar formens textalternativ.|
| [text](/cells/python-net/sv/aspose.cells.drawing/picture/text) | Representerar strängen i detta TextBox-objekt.|
| [is_rich_text](/cells/python-net/sv/aspose.cells.drawing/picture/is_rich_text) | Om texten är rik text eller inte.|
| [html_text](/cells/python-net/sv/aspose.cells.drawing/picture/html_text) | Hämtar och ställer in html-strängen som innehåller data och vissa format i den här textrutan.|
| [text_vertical_overflow](/cells/python-net/sv/aspose.cells.drawing/picture/text_vertical_overflow) | Hämtar och ställer in textens vertikala överflödestyp för formen som innehåller text.|
| [text_horizontal_overflow](/cells/python-net/sv/aspose.cells.drawing/picture/text_horizontal_overflow) | Hämtar och ställer in textens horisontella överflödestyp för formen som innehåller text.|
| [is_text_wrapped](/cells/python-net/sv/aspose.cells.drawing/picture/is_text_wrapped) | Hämtar och ställer in texttypen för formen som innehåller text.|
| [text_orientation_type](/cells/python-net/sv/aspose.cells.drawing/picture/text_orientation_type) | Hämtar och ställer in formens textorienteringstyp.|
| [text_horizontal_alignment](/cells/python-net/sv/aspose.cells.drawing/picture/text_horizontal_alignment) | Hämtar och ställer in textens horisontella anpassningstyp för formen.|
| [text_vertical_alignment](/cells/python-net/sv/aspose.cells.drawing/picture/text_vertical_alignment) | Hämtar och ställer in textens vertikala inriktningstyp för formen.|
| [text_direction](/cells/python-net/sv/aspose.cells.drawing/picture/text_direction) | Hämtar/ställer in textflödets riktning för detta objekt.|
| [control_data](/cells/python-net/sv/aspose.cells.drawing/picture/control_data) | Får kontrolldata.|
| [active_x_control](/cells/python-net/sv/aspose.cells.drawing/picture/active_x_control) | Hämtar ActiveX-kontrollen.|
| [paths](/cells/python-net/sv/aspose.cells.drawing/picture/paths) |Får vägarna för en anpassad geometrisk form.|
| [geometry](/cells/python-net/sv/aspose.cells.drawing/picture/geometry) | Får geometrin|
| [create_id](/cells/python-net/sv/aspose.cells.drawing/picture/create_id) | Hämtar och sätter skapa id för denna form.|
...
| [image_type](/cells/python-net/sv/aspose.cells.drawing/picture/image_type) | Hämtar bildens bildformat.|
| [original_height_cm](/cells/python-net/sv/aspose.cells.drawing/picture/original_height_cm) | Får bildens ursprungliga höjd, i centimeterenhet.|
| [original_width_cm](/cells/python-net/sv/aspose.cells.drawing/picture/original_width_cm) | Får bildens ursprungliga bredd, i centimeterenhet.|
| [original_height_inch](/cells/python-net/sv/aspose.cells.drawing/picture/original_height_inch) | Får bildens ursprungliga höjd, i enhet av tum.|
| [original_width_inch](/cells/python-net/sv/aspose.cells.drawing/picture/original_width_inch) | Får bildens ursprungliga bredd, i enhet av tum.|
| [signature_line](/cells/python-net/sv/aspose.cells.drawing/picture/signature_line) | Hämtar och ställer in signaturlinjen|
