...
type: docs
weight: 20
url: /sv/aspose.cells.drawing/shapeguidecollection/add/
is_root: false
---
##  add(self, name, val) {#str-float}
Lägger till en formguide. (Viktigt: Den här funktionen är för närvarande endast tillgänglig för Excel07 och senare)
