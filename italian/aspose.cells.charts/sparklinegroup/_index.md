...
[`Sparkline`](/cells/python-net/it/aspose.cells.charts/sparkline) è organizzato in un gruppo sparkline. Un gruppo SparklineGroup contiene un numero variabile di elementi sparkline.
...
Il tipo SparklineGroup espone i seguenti membri:
...
| [sparkline_collection](/cells/python-net/it/aspose.cells.charts/sparklinegroup/sparkline_collection) | Ottiene la raccolta di oggetti [`Sparkline`](/cells/python-net/it/aspose.cells.charts/sparkline).|
| [sparklines](/cells/python-net/it/aspose.cells.charts/sparklinegroup/sparklines) | Ottiene la raccolta di oggetti [`Sparkline`](/cells/python-net/it/aspose.cells.charts/sparkline).|
...
| [display_hidden](/cells/python-net/it/aspose.cells.charts/sparklinegroup/display_hidden) | Indica se visualizzare i dati nelle righe e nelle colonne nascoste.|
...
| [high_point_color](/cells/python-net/it/aspose.cells.charts/sparklinegroup/high_point_color) | Ottiene e imposta il colore dei punti più alti dei dati nel gruppo sparkline.|
| [show_low_point](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_low_point) | Indica se evidenziare i punti più bassi dei dati nel gruppo sparkline.|
| [low_point_color](/cells/python-net/it/aspose.cells.charts/sparklinegroup/low_point_color) | Ottiene e imposta il colore dei punti più bassi dei dati nel gruppo sparkline.|
| [show_negative_points](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_negative_points) |Indica se evidenziare i valori negativi nel gruppo sparkline con un colore o un marcatore diverso.|
...
| [show_markers](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_markers) | Indica se evidenziare ogni punto in ogni grafico sparkline nel gruppo di grafici sparkline.|
| [markers_color](/cells/python-net/it/aspose.cells.charts/sparklinegroup/markers_color) | Ottiene e imposta il colore dei punti in ogni linea sparkline nel gruppo sparkline.|
| [series_color](/cells/python-net/it/aspose.cells.charts/sparklinegroup/series_color) | Ottiene e imposta il colore degli sparkline nel gruppo sparkline.|
...
| [line_weight](/cells/python-net/it/aspose.cells.charts/sparklinegroup/line_weight) | Ottiene e imposta lo spessore della linea in ogni grafico sparkline del gruppo, nell'unità di punti.|
...
| [show_horizontal_axis](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_horizontal_axis) | Indica se visualizzare l'asse orizzontale dello sparkline.<br/> L'asse orizzontale viene visualizzato se il grafico sparkline contiene dati che attraversano l'asse zero.|
...
| Metodo| Descrizione|
| :- | :- |
| [`reset_ranges(self, data_range, is_vertical, location_range)`](/cells/python-net/it/aspose.cells.charts/sparklinegroup/reset_ranges/#str-bool-aspose.cells.cellarea) | Reimposta l'intervallo dati e l'intervallo di posizione del gruppo sparkline.<br/> Questo metodo eliminerà gli elementi sparkline originali nel gruppo e creerà nuovi elementi sparkline per i nuovi intervalli.|
