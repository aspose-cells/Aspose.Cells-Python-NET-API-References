...
[`Sparkline`](/cells/python-net/it/aspose.cells.charts/sparkline) è organizzato in gruppo sparkline. Un numero SparklineGroup contiene un numero variabile di elementi sparkline.
Un gruppo sparkline specifica il tipo, le impostazioni di visualizzazione e le impostazioni degli assi per gli sparkline.
...
| [type](/cells/python-net/it/aspose.cells.charts/sparklinegroup/type) | Indica il tipo di sparkline del gruppo sparkline.|
...
| [show_high_point](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_high_point) | Indica se evidenziare i punti di dati più alti nel gruppo sparkline.|
| [high_point_color](/cells/python-net/it/aspose.cells.charts/sparklinegroup/high_point_color) | Ottiene e imposta il colore dei punti di dati più alti nel gruppo sparkline.|
...
| [show_negative_points](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_negative_points) | Indica se evidenziare i valori negativi sul gruppo sparkline con un colore o un indicatore diverso.|
...
| [show_markers](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_markers) | Indica se evidenziare ciascun punto in ciascuna linea sparkline nel gruppo sparkline.|
...
| [line_weight](/cells/python-net/it/aspose.cells.charts/sparklinegroup/line_weight) | Ottiene e imposta lo spessore della linea in ogni linea sparkline nel gruppo sparkline, nell'unità di punti.|
...
| [show_horizontal_axis](/cells/python-net/it/aspose.cells.charts/sparklinegroup/show_horizontal_axis) | Indica se mostrare l'asse orizzontale dello sparkline.<br/> L'asse orizzontale viene visualizzato se la sparkline contiene dati che attraversano l'asse zero.|
...
| Metodo| Descrizione|
| :- | :- |
| [reset_ranges](/cells/python-net/it/aspose.cells.charts/sparklinegroup/reset_ranges/#str-bool-aspose.cells.CellArea) | Reimposta l'intervallo di dati e l'intervallo di posizioni del gruppo sparkline.<br/> Questo metodo cancellerà gli elementi sparkline originali nel gruppo e creerà nuovi elementi sparkline per i nuovi intervalli.|
