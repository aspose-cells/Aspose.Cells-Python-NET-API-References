...
type: docs
weight: 350
url: /it/aspose.cells.charts/displayunitlabel/shape_properties/
is_root: false
---
##  shape_properties proprietà

Ottiene l'oggetto [`ChartFrame.shape_properties`](/cells/python-net/it/aspose.cells.charts/chartframe#shape_properties).
###  Definizione:
```python
@property
