---
title: inner_height_ratio_to_chart proprietà
second_title: Aspose.Cells for Python via .NET API Riferimenti
description:
type: docs
weight: 220
url: /it/aspose.cells.charts/plotarea/inner_height_ratio_to_chart/
is_root: false
---
##  inner_height_ratio_to_chart proprietà

Ottiene o imposta l'altezza dell'area del grafico in unità di rapporto dell'area del grafico.
...
Altezza interna in pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Definizione:
```python
@property
