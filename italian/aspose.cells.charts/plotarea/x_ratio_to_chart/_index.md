...
type: docs
weight: 410
url: /it/aspose.cells.charts/plotarea/x_ratio_to_chart/
is_root: false
---
##  x_ratio_to_chart proprietà

Ottiene o ottiene la coordinata x dell'angolo superiore sinistro del riquadro di delimitazione dell'area del grafico in unità di rapporto dell'area del grafico.
...
XPixel = XRatioToChart * grafico.ChartObject.Larghezza.
###  Definizione:
```python
@property
