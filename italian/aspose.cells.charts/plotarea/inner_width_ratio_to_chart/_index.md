---
title: inner_width_ratio_to_chart proprietà
second_title: Aspose.Cells for Python via .NET API Riferimenti
description:
type: docs
weight: 240
url: /it/aspose.cells.charts/plotarea/inner_width_ratio_to_chart/
is_root: false
---
##  inner_width_ratio_to_chart proprietà

Ottiene o imposta la larghezza dell'area del grafico in unità di rapporto dell'area del grafico.
...
Larghezza interna in pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Definizione:
```python
@property
