---
title: inner_y_ratio_to_chart proprietà
second_title: Aspose.Cells for Python via .NET API Riferimenti
description:
type: docs
weight: 280
url: /it/aspose.cells.charts/plotarea/inner_y_ratio_to_chart/
is_root: false
---
##  inner_y_ratio_to_chart proprietà

Ottiene o ottiene la coordinata x dell'angolo superiore destro dell'area del grafico in unità di rapporto dell'area del grafico.
