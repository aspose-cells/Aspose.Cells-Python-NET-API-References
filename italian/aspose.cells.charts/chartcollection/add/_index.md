...
si prega di utilizzare la proprietà [ChartCollection.add(type, upper_left_row, upper_left_column, lower_right_row, lower_right_column)](/cells/python-net/it/aspose.cells.charts/chartcollection/add).
