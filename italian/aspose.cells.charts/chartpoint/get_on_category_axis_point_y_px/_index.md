...
type: docs
weight: 70
url: /it/aspose.cells.charts/chartpoint/get_on_category_axis_point_y_px/
is_root: false
---
##  get_on_category_axis_point_y_px(self, index) {#int}
Ottiene la coordinata y del punto sull'asse delle categorie dopo aver chiamato il metodo Chart.Calculate(). Si applica solo ai grafici ad area.
