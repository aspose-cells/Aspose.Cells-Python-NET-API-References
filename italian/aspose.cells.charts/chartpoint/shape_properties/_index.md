...
type: docs
weight: 340
url: /it/aspose.cells.charts/chartpoint/shape_properties/
is_root: false
---
##  shape_properties proprietà

Ottiene l'oggetto [`ShapePropertyCollection`](/cells/python-net/it/aspose.cells.drawing/shapepropertycollection) che contiene le proprietà della forma visiva di ChartPoint.
###  Definizione:
```python
@property
