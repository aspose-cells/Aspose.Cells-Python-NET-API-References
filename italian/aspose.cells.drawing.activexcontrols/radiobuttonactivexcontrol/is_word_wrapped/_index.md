...
type: docs
weight: 190
url: /it/aspose.cells.drawing.activexcontrols/radiobuttonactivexcontrol/is_word_wrapped/
is_root: false
---
##  is_word_wrapped proprietà

Indica se il contenuto del controllo va automaticamente a capo alla fine di una riga.
###  Definizione:
```python
@property
