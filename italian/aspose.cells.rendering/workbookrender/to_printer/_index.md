...
Esegui il rendering della cartella di lavoro sulla stampante
...
| :- | :- | :- |
| printer_name | str | il nome della stampante, ad esempio: "Microsoft Office Document Image Writer"|
| print_page_index | int | l'indice basato su 0 della prima pagina da stampare, deve essere compreso nell'intervallo [0, WorkbookRender.PageCount-1]|
