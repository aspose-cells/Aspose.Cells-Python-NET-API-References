...
type: docs
weight: 10
url: /it/aspose.cells.ods/
is_root: false
---
 IL**Aspose.Cells.Ods**namespace contiene tutte le classi di caricamento e conversione dei file OpenDocument Spreadsheet.
...
| :- | :- |
| [`OdsCellFieldType`](/cells/python-net/it/aspose.cells.ods/odscellfieldtype) | Rappresenta il tipo di campo cellulare di ods.|
...
| [`OpenDocumentFormatVersionType`](/cells/python-net/it/aspose.cells.ods/opendocumentformatversiontype) | Tipo di versione Open Document Format.|
