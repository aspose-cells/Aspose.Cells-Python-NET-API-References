...
type: docs
weight: 50
url: /it/aspose.cells.datamodels/datamodelrelationshipcollection/last_index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [`DataModelRelationship`](/cells/python-net/it/aspose.cells.datamodels/datamodelrelationship) | L'oggetto da individuare nell'elenco dell'array. Il valore può essere null.|
...
###  Guarda anche
* modulo [`aspose.cells.datamodels`](../../)
* classe [`DataModelRelationshipCollection`](/cells/python-net/it/aspose.cells.datamodels/datamodelrelationshipcollection)
