...
Quando il modello di formattazione della cella viene combinato con modelli di formattazione condizionale,
...
quindi quando il valore della cella è numerico e diverso da 0, il tipo restituito è [`NumberCategoryType.NUMBER`](/cells/python-net/it/aspose.cells/numbercategorytype#NUMBER);
