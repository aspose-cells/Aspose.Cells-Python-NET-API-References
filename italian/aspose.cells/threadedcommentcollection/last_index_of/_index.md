...
type: docs
weight: 60
url: /it/aspose.cells/threadedcommentcollection/last_index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [`ThreadedComment`](/cells/python-net/it/aspose.cells/threadedcomment) | L'oggetto da individuare nell'elenco dell'array. Il valore può essere null.|
...
###  Guarda anche
* modulo [`aspose.cells`](../../)
* classe [`ThreadedCommentCollection`](/cells/python-net/it/aspose.cells/threadedcommentcollection)
