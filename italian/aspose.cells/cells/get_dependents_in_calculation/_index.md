...
Per maggiori dettagli ed esempio, vedere [Cell.get_dependents_in_calculation(recursive)](/cells/python-net/it/aspose.cells/cell/get_dependents_in_calculation)
