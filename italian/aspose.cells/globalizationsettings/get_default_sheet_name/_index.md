...
type: docs
weight: 80
url: /it/aspose.cells/globalizationsettings/get_default_sheet_name/
is_root: false
---
...
Quello aggiunto automaticamente (ad esempio da [`WorksheetCollection.add`](/cells/python-net/it/aspose.cells/worksheetcollection/add))
il nome del foglio sarà il nome specificato più il numero di sequenza.
 Ad esempio, per la Germania l'utente potrebbe volere che il nome del foglio sia "Tabellenblatt2" anziché "Foglio2".
