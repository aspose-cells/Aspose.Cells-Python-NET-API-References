...
type: docs
weight: 170
url: /it/aspose.cells.pivot/pivotfield/hide_item_detail/
is_root: false
---
##  hide_item_detail(self, index, is_hidden_detail) {#int-bool}
Imposta se lo specifico PivotItem in un campo pivot è un dettaglio nascosto.
...
| is_hidden_detail | bool | se lo specifico PivotItem è nascosto|
