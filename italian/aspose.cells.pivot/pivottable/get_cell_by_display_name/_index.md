...
type: docs
weight: 130
url: /it/aspose.cells.pivot/pivottable/get_cell_by_display_name/
is_root: false
---
##  get_cell_by_display_name(self, display_name) {#str}
Ottiene l'oggetto [`Cell`](/cells/python-net/it/aspose.cells/cell) tramite il nome visualizzato di PivotField.
...
| :- | :- | :- |
| display_name | str | il DisplayName del PivotField|
