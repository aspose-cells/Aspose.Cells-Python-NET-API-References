...
| [show_table_style_last_column](/cells/python-net/it/aspose.cells.tables/listobject/show_table_style_last_column) | Indica se lo stile deve essere applicato all'ultima colonna della tabella.|
| [show_table_style_row_stripes](/cells/python-net/it/aspose.cells.tables/listobject/show_table_style_row_stripes) | Indica se viene applicata la formattazione delle strisce di riga.|
| [show_table_style_column_stripes](/cells/python-net/it/aspose.cells.tables/listobject/show_table_style_column_stripes) | Indica se viene applicata la formattazione delle strisce di colonne.|
| [table_style_type](/cells/python-net/it/aspose.cells.tables/listobject/table_style_type) | Ottiene e lo stile di tabella predefinito.|
...
| [xml_map](/cells/python-net/it/aspose.cells.tables/listobject/xml_map) | Ottiene un [ListObject.xml_map](/cells/python-net/it/aspose.cells.tables/listobject#xml_map) usato per questo elenco.|
...
| Metodo| Descrizione|
| :- | :- |
| [convert_to_range()](/cells/python-net/it/aspose.cells.tables/listobject/convert_to_range/#) | Converti la tabella in intervallo.|
| [convert_to_range(options)](/cells/python-net/it/aspose.cells.tables/listobject/convert_to_range/#TableToRangeOptions) | Converti la tabella in intervallo.|
| [resize(start_row, start_column, end_row, end_column, has_headers)](/cells/python-net/it/aspose.cells.tables/listobject/resize/#int-int-int-int-bool) | Ridimensiona l'intervallo dell'oggetto elenco.|
| [put_cell_value(row_offset, column_offset, value)](/cells/python-net/it/aspose.cells.tables/listobject/put_cell_value/#int-int-any) | Inserisci il valore nella cella.|
| [update_column_name()](/cells/python-net/it/aspose.cells.tables/listobject/update_column_name/#) |Aggiorna il nome di tutte le colonne dell'elenco dal foglio di lavoro.|
| [filter()](/cells/python-net/it/aspose.cells.tables/listobject/filter/#) | Filtra la tabella.|
| [apply_style_to_range()](/cells/python-net/it/aspose.cells.tables/listobject/apply_style_to_range/#) | Applica lo stile della tabella all'intervallo.|
