...
type: docs
weight: 20
url: /it/aspose.cells.lowcode/jsonconverter/process/
is_root: false
---
##  process(, file_modello, file_risultato){#str-str}
Converte il file modello specificato tra json e altri formati.
...
Converte i dati tra JSON e altri formati di file di fogli di calcolo.
...
* classe [`JsonConverter`](/cells/python-net/it/aspose.cells.lowcode/jsonconverter)
