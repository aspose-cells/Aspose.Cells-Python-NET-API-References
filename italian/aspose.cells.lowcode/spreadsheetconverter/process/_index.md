...
type: docs
weight: 20
url: /it/aspose.cells.lowcode/spreadsheetconverter/process/
is_root: false
---
##  process(, file_modello, file_risultato){#str-str}
Converte il file modello specificato tra formati di file di foglio di calcolo.
...
* classe [`SpreadsheetConverter`](/cells/python-net/it/aspose.cells.lowcode/spreadsheetconverter)
