...
type: docs
weight: 20
url: /it/aspose.cells.lowcode/textconverter/process/
is_root: false
---
##  process(, file_modello, file_risultato){#str-str}
Converte il file modello specificato tra file basati su testo e altri formati.
...
| :- | :- | :- |
| template_file | str | Il file modello da convertire|
...
Converte il formato del file tra formati basati su testo e altri formati di file di fogli di calcolo
...
* classe [`TextConverter`](/cells/python-net/it/aspose.cells.lowcode/textconverter)
