...
type: docs
weight: 60
url: /it/aspose.cells.metas/sensitivitylabelcollection/last_index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [`SensitivityLabel`](/cells/python-net/it/aspose.cells.metas/sensitivitylabel) | L'oggetto da individuare nell'elenco dell'array. Il valore può essere null.|
...
###  Guarda anche
* modulo [`aspose.cells.metas`](../../)
* classe [`SensitivityLabelCollection`](/cells/python-net/it/aspose.cells.metas/sensitivitylabelcollection)
