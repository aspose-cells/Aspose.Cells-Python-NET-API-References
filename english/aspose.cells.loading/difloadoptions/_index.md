...
| :- | :- |
| [`__init__(self)`](/cells/python-net/aspose.cells.loading/difloadoptions/__init__/#) | The options. |
...
| [region](/cells/python-net/aspose.cells.loading/difloadoptions/region) | Gets or sets the regional settings used for the Workbook that will be loaded. |
...
| [memory_setting](/cells/python-net/aspose.cells.loading/difloadoptions/memory_setting) | Gets or sets the memory mode for loaded workbook. |
...
| Method | Description |
| :- | :- |
| [`set_paper_size(self, type)`](/cells/python-net/aspose.cells.loading/difloadoptions/set_paper_size/#aspose.cells.papersizetype) | Sets the default print paper size from default printer's setting. |
