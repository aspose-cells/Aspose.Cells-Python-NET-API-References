...
| [convert_numeric_data](/cells/python-net/aspose.cells/abstracttextloadoptions/convert_numeric_data) | Gets or sets a value that indicates whether the string in text file is converted to numeric data.<br/>Default value is true. |
| [convert_date_time_data](/cells/python-net/aspose.cells/abstracttextloadoptions/convert_date_time_data) | Gets or sets a value that indicates whether the string in text file is converted to date data.<br/>Default value is true. |
