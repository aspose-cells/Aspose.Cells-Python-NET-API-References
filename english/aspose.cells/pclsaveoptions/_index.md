...
| [cached_file_folder](/cells/python-net/aspose.cells/pclsaveoptions/cached_file_folder) | The folder for temporary files that may be used as data cache. |
...
| [gridline_color](/cells/python-net/aspose.cells/pclsaveoptions/gridline_color) | Gets or sets gridline color. |
...
| [custom_render_settings](/cells/python-net/aspose.cells/pclsaveoptions/custom_render_settings) | Gets or sets custom settings during rendering. |
