...
| [paragraph_layout_mode](/cells/python-net/aspose.cells/htmlloadoptions/paragraph_layout_mode) | Specifies how HTML <p> elements are rendered when loading HTML.<br/>The default value is [`HtmlParagraphLayoutMode.NORMAL`](/cells/python-net/aspose.cells.rendering/htmlparagraphlayoutmode#NORMAL). |
