...
type: docs
weight: 50
url: /aspose.cells/filtervaluecollection/index_of/
is_root: false
---

## index_of(self, item, index) {#aspose.cells.FilterValue-int}
...
## index_of(self, item, index, count) {#aspose.cells.FilterValue-int-int}
