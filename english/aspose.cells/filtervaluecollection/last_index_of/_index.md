...
type: docs
weight: 60
url: /aspose.cells/filtervaluecollection/last_index_of/
is_root: false
---

## last_index_of(self, item) {#aspose.cells.FilterValue}
...
| :- | :- | :- |
| item | aspose.cells.FilterValue | The object to locate in the array list. The value can be null. |


## last_index_of(self, item, index) {#aspose.cells.FilterValue-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.FilterValue-int-int}
