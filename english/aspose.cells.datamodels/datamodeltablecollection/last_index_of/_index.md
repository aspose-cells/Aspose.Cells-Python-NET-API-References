...
## last_index_of {#aspose.cells.datamodels.DataModelTable}
...
| :- | :- | :- |
| item | [`DataModelTable`](/cells/python-net/aspose.cells.datamodels/datamodeltable) | The object to locate in the array list. The value can be null. |


## last_index_of {#aspose.cells.datamodels.DataModelTable-int}
...
## last_index_of {#aspose.cells.datamodels.DataModelTable-int-int}
