...
| Method | Description |
| :- | :- |
| [set_one_color_gradient](/cells/python-net/aspose.cells.drawing/msofillformathelper/set_one_color_gradient/#aspose.pydrawing.Color-float-aspose.cells.drawing.GradientStyleType-int) | Sets the specified fill to a one-color gradient. |
