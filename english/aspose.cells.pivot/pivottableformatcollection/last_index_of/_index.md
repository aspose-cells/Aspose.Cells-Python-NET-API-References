...
type: docs
weight: 70
url: /aspose.cells.pivot/pivottableformatcollection/last_index_of/
is_root: false
---

## last_index_of {#aspose.cells.pivot.PivotTableFormat}
...
| :- | :- | :- |
| item | [`PivotTableFormat`](/cells/python-net/aspose.cells.pivot/pivottableformat) | The object to locate in the array list. The value can be null. |


## last_index_of {#aspose.cells.pivot.PivotTableFormat-int}
...
## last_index_of {#aspose.cells.pivot.PivotTableFormat-int-int}
