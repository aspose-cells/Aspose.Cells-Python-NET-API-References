...
type: docs
weight: 70
url: /aspose.cells.pivot/pivotfieldcollection/index_of/
is_root: false
---

## index_of(self, item, index) {#aspose.cells.pivot.PivotField-int}
...
## index_of(self, item, index, count) {#aspose.cells.pivot.PivotField-int-int}
