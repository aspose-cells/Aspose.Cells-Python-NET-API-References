...
type: docs
weight: 80
url: /aspose.cells.pivot/pivotfieldcollection/last_index_of/
is_root: false
---

## last_index_of(self, item) {#aspose.cells.pivot.PivotField}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotField | The object to locate in the array list. The value can be null. |


## last_index_of(self, item, index) {#aspose.cells.pivot.PivotField-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotField-int-int}
