...
type: docs
weight: 50
url: /aspose.cells.pivot/pivotareafiltercollection/last_index_of/
is_root: false
---

## last_index_of {#aspose.cells.pivot.PivotAreaFilter}
...
| :- | :- | :- |
| item | [`PivotAreaFilter`](/cells/python-net/aspose.cells.pivot/pivotareafilter) | The object to locate in the array list. The value can be null. |


## last_index_of {#aspose.cells.pivot.PivotAreaFilter-int}
...
## last_index_of {#aspose.cells.pivot.PivotAreaFilter-int-int}
