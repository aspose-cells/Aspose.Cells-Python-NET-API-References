...
type: docs
weight: 40
url: /aspose.cells.pivot/pivotcachecollection/index_of/
is_root: false
---

## index_of(self, item, index) {#aspose.cells.pivot.PivotCache-int}
...
## index_of(self, item, index, count) {#aspose.cells.pivot.PivotCache-int-int}
