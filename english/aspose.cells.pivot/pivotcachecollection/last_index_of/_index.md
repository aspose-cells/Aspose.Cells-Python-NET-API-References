...
type: docs
weight: 50
url: /aspose.cells.pivot/pivotcachecollection/last_index_of/
is_root: false
---

## last_index_of(self, item) {#aspose.cells.pivot.PivotCache}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotCache | The object to locate in the array list. The value can be null. |


## last_index_of(self, item, index) {#aspose.cells.pivot.PivotCache-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotCache-int-int}
...
* class [`PivotCacheCollection`](/cells/python-net/aspose.cells.pivot/pivotcachecollection)
