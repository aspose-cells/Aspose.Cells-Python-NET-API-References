...
type: docs
weight: 70
url: /aspose.cells.pivot/pivotitemcollection/index_of/
is_root: false
---

## index_of(self, item, index) {#aspose.cells.pivot.PivotItem-int}
...
## index_of(self, item, index, count) {#aspose.cells.pivot.PivotItem-int-int}
