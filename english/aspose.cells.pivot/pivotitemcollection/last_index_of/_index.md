...
type: docs
weight: 80
url: /aspose.cells.pivot/pivotitemcollection/last_index_of/
is_root: false
---

## last_index_of(self, item) {#aspose.cells.pivot.PivotItem}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotItem | The object to locate in the array list. The value can be null. |


## last_index_of(self, item, index) {#aspose.cells.pivot.PivotItem-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotItem-int-int}
