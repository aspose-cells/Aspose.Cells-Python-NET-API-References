...
| [`add_registered_reference(self, name, libid)`](/cells/python-net/aspose.cells.vba/vbaprojectreferencecollection/add_registered_reference/#str-str) | Add a reference to an Automation type library. |
| [`add_control_refrernce(self, name, libid, twiddledlibid, extended_libid)`](/cells/python-net/aspose.cells.vba/vbaprojectreferencecollection/add_control_refrernce/#str-str-str-str) | Add a reference to a twiddled type library and its extended type library. |
| [`add_project_refrernce(self, name, absolute_libid, relative_libid)`](/cells/python-net/aspose.cells.vba/vbaprojectreferencecollection/add_project_refrernce/#str-str-str) | Adds a reference to an external VBA project. |
