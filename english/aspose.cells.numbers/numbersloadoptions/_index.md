...
| [region](/cells/python-net/aspose.cells.numbers/numbersloadoptions/region) | Gets or sets the regional settings used for the Workbook that will be loaded. |
...
| [memory_setting](/cells/python-net/aspose.cells.numbers/numbersloadoptions/memory_setting) | Gets or sets the memory mode for loaded workbook. |
