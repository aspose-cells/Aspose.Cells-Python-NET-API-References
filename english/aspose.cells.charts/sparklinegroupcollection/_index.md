...
| [`clear_sparklines(self, cell_area)`](/cells/python-net/aspose.cells.charts/sparklinegroupcollection/clear_sparklines/#aspose.cells.cellarea) | Clears the sparklines that are inside an area of cells. |
| [`clear_sparkline_groups(self, cell_area)`](/cells/python-net/aspose.cells.charts/sparklinegroupcollection/clear_sparkline_groups/#aspose.cells.cellarea) | Clears the sparkline groups that overlap an area of cells. |
