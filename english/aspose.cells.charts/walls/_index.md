...
| [center_y](/cells/python-net/aspose.cells.charts/walls/center_y) | Gets the y coordinate of the left-bottom corner of Wall center in units of 1/4000 of chart's height after calling the Chart.Calculate() method. |
...
| [depth](/cells/python-net/aspose.cells.charts/walls/depth) | Gets the depth front to back in units of 1/4000 of chart's width after calling the Chart.Calculate() method. |
...
| [center_x_px](/cells/python-net/aspose.cells.charts/walls/center_x_px) | Gets the x coordinate of the left-bottom corner of Wall center in units of pixels after calling the Chart.Calculate() method. |
...
| [width_px](/cells/python-net/aspose.cells.charts/walls/width_px) | Gets the width of left to right in units of pixels after calling the Chart.Calculate() method. |
...
| [height_px](/cells/python-net/aspose.cells.charts/walls/height_px) | Gets the height from top to bottom in units of pixels after calling the Chart.Calculate() method. |
...
| [`get_cube_point_x_px(self, index)`](/cells/python-net/aspose.cells.charts/walls/get_cube_point_x_px/#int) | Gets x-coordinate of the apex point of walls cube after calling the Chart.Calculate() method.<br/>The number of apex points of walls cube is eight |
