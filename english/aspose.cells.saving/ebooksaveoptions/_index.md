...
| [merge_empty_td_type](/cells/python-net/aspose.cells.saving/ebooksaveoptions/merge_empty_td_type) | Indicates if empty TD element will be merged in the same way as MS Excel when saving an Excel file in html format.<br/>The default value is MergeEmptyTdType.Default. |
