...
type: docs
weight: 320
url: /ru/aspose.cells.saving/ebooksaveoptions/export_frame_scripts_and_properties/
is_root: false
---
##  export_frame_scripts_and_properties недвижимость

Указывает, экспортируются ли скрипты фреймов и свойства документа. Значение по умолчанию — true. Если вы хотите импортировать файл HTML или MHT,
для Excel оставьте значение по умолчанию.
###  Определение:
```python
@property
