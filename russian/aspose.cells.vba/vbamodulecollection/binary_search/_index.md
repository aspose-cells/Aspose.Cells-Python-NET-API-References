...
type: docs
weight: 50
url: /ru/aspose.cells.vba/vbamodulecollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`VbaModule`](/cells/python-net/ru/aspose.cells.vba/vbamodule) | Системный объект, который нужно найти. Значение может быть null.|
