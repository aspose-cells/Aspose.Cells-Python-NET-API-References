...
type: docs
weight: 240
url: /ru/aspose.cells.drawing.texts/textoptions/shadow/
is_root: false
---
##  shadow недвижимость

Представляет объект [`ShadowEffect`](/cells/python-net/ru/aspose.cells.drawing/shadoweffect), который задает эффект shadow для элемента или фигуры диаграммы.
###  Определение:
```python
@property
def shadow(self):
