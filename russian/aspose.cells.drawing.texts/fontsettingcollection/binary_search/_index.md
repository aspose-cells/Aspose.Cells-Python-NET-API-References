...
type: docs
weight: 30
url: /ru/aspose.cells.drawing.texts/fontsettingcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`FontSetting`](/cells/python-net/ru/aspose.cells/fontsetting) | Системный объект, который нужно найти. Значение может быть null.|
