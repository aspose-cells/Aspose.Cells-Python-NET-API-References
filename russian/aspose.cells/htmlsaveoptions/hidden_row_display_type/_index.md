...
Если HtmlHiddenRowDisplayType равно «Remove», то скрытая строка не будет выводиться,
Если значение равно «Скрыто», строка будет выведена, но будет скрыта, значение по умолчанию — «Скрыто».
###  Определение:
```python
@property
