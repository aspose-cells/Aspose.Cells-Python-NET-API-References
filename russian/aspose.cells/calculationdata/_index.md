...
| Свойство| Описание|
| :- | :- |
| [calculated_value](/cells/python-net/ru/aspose.cells/calculationdata/calculated_value) | Получает или задает вычисленное значение для этой функции.|
...
| Метод| Описание|
| :- | :- |
| [get_param_value(index)](/cells/python-net/ru/aspose.cells/calculationdata/get_param_value/#int) | Получает представленный объект значения параметра по заданному индексу.|
| [get_param_text(index)](/cells/python-net/ru/aspose.cells/calculationdata/get_param_text/#int) | Получает буквальный текст параметра по заданному индексу.|
