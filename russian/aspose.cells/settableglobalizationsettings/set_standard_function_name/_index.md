---
title: set_standard_function_name метод
second_title: Aspose.Cells for Python via .NET API Ссылки
description:
type: docs
weight: 380
url: /ru/aspose.cells/settableglobalizationsettings/set_standard_function_name/
is_root: false
---
...
| bidirectional | bool | Будет ли автоматически сопоставлять имя стандартной функции с именем локальной функции.<br/>Если true, стандартное имя будет автоматически сопоставлено с локальным именем.<br/>поэтому пользователю не нужно снова звонить по номеру [`SettableGlobalizationSettings.set_local_function_name`](/cells/python-net/ru/aspose.cells/settableglobalizationsettings/set_local_function_name)<br/> для одной и той же пары стандартных и локальных имен|
