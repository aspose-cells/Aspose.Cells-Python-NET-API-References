...
type: docs
weight: 30
url: /ru/aspose.cells/xmlmapcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`XmlMap`](/cells/python-net/ru/aspose.cells/xmlmap) | Системный объект, который нужно найти. Значение может быть null.|
