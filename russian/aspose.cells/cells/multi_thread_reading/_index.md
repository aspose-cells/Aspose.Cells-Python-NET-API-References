...
такие как значения форматирования (по [Cell.string_value](/cells/python-net/ru/aspose.cells/cell#string_value), [Cell.display_string_value](/cells/python-net/ru/aspose.cells/cell#display_string_value) и т. д.).
