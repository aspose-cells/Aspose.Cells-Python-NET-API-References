...
| [comment_shape](/cells/python-net/ru/aspose.cells/comment/comment_shape) | Получите объект Shape, представляющий фигуру, прикрепленную к указанному комментарию.|
