...
type: docs
weight: 40
url: /ru/aspose.cells/commentcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`Comment`](/cells/python-net/ru/aspose.cells/comment) | Системный объект, который нужно найти. Значение может быть null.|
