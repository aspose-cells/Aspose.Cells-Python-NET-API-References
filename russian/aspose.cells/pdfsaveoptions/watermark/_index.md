---
title: watermark недвижимость
second_title: Aspose.Cells for Python via .NET API Ссылки
description:
type: docs
weight: 510
url: /ru/aspose.cells/pdfsaveoptions/watermark/
is_root: false
---
##  watermark недвижимость

Получает или задает watermark для вывода.

###  Пример

Следующий код устанавливает watermark в выходном PDF-файле.
...
* класс [`RenderingWatermark`](/cells/python-net/ru/aspose.cells.rendering/renderingwatermark)
