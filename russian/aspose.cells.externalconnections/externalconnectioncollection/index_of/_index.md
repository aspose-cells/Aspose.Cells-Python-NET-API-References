...
type: docs
weight: 50
url: /ru/aspose.cells.externalconnections/externalconnectioncollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [ExternalConnection](/cells/python-net/ru/aspose.cells.externalconnections/externalconnection) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
