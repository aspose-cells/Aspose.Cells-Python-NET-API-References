...
type: docs
weight: 20
url: /ru/aspose.cells.externalconnections/connectionparametercollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`ConnectionParameter`](/cells/python-net/ru/aspose.cells.externalconnections/connectionparameter) | Системный объект, который нужно найти. Значение может быть null.|
