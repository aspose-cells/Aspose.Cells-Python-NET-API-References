...
type: docs
weight: 60
url: /ru/aspose.cells.charts/pivotoptions/drop_zone_series/
is_root: false
---
##  drop_zone_series недвижимость

Указывает, есть ли элемент управления для каждого поля сводной таблицы на оси столбцов сводной таблицы.
