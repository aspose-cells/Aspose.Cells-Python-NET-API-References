---
title: inner_width_ratio_to_chart недвижимость
second_title: Aspose.Cells for Python via .NET API Ссылки
description:
type: docs
weight: 240
url: /ru/aspose.cells.charts/plotarea/inner_width_ratio_to_chart/
is_root: false
---
##  inner_width_ratio_to_chart недвижимость

Возвращает или задает ширину области построения в единицах отношения площади диаграммы.
...
InnerWidth в пикселях = InnerXRatioToChart *chart.ChartObject.Width.
###  Определение:
```python
@property
