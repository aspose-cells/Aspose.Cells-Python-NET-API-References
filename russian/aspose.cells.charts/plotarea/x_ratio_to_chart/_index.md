...
type: docs
weight: 410
url: /ru/aspose.cells.charts/plotarea/x_ratio_to_chart/
is_root: false
---
##  x_ratio_to_chart недвижимость

Возвращает или возвращает координату x верхнего левого угла ограничивающего прямоугольника области построения в единицах отношения площади диаграммы.
