---
title: inner_x_ratio_to_chart недвижимость
second_title: Aspose.Cells for Python via .NET API Ссылки
description:
type: docs
weight: 260
url: /ru/aspose.cells.charts/plotarea/inner_x_ratio_to_chart/
is_root: false
---
##  inner_x_ratio_to_chart недвижимость
...
InnerX в пикселях = InnerXRatioToChart *chart.ChartObject.Width.
###  Определение:
```python
@property
