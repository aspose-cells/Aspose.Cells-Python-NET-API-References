...
type: docs
weight: 380
url: /ru/aspose.cells.charts/plotarea/width_ratio_to_chart/
is_root: false
---
##  width_ratio_to_chart недвижимость

Возвращает или задает ширину ограничивающей рамки области построения в единицах отношения площади диаграммы.
