...
type: docs
weight: 200
url: /ru/aspose.cells.charts/plotarea/height_ratio_to_chart/
is_root: false
---
##  height_ratio_to_chart недвижимость

Возвращает или задает высоту ограничивающей рамки области построения в единицах отношения площади диаграммы.
