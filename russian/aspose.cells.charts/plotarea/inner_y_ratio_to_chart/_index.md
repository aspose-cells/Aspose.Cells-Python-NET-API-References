---
title: inner_y_ratio_to_chart недвижимость
second_title: Aspose.Cells for Python via .NET API Ссылки
description:
type: docs
weight: 280
url: /ru/aspose.cells.charts/plotarea/inner_y_ratio_to_chart/
is_root: false
---
##  inner_y_ratio_to_chart недвижимость

Возвращает или возвращает координату x верхнего верхнего угла области построения в единицах отношения площади диаграммы.
...
ВнутреннийY в пикселях = ВнутреннийYRatioToChart * chart.ChartObject.Width.
###  Определение:
```python
@property
