...
type: docs
weight: 360
url: /ru/aspose.cells.charts/plotarea/width/
is_root: false
---
##  width недвижимость

Возвращает или задает значение width ограничивающей рамки области построения в единицах, равных 1/4000 области диаграммы.
