...
type: docs
weight: 30
url: /ru/aspose.cells.charts/sparklinegroupcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`SparklineGroup`](/cells/python-net/ru/aspose.cells.charts/sparklinegroup) | Системный объект, который нужно найти. Значение может быть null.|
