...
type: docs
weight: 170
url: /ru/aspose.cells.charts/ticklabels/tick_label_items/
is_root: false
---
...
Доступно только после вызова метода [`Chart.calculate`](/cells/python-net/ru/aspose.cells.charts/chart/calculate).
###  Определение:
```python
@property
