...
type: docs
weight: 40
url: /ru/aspose.cells.charts/seriescollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`Series`](/cells/python-net/ru/aspose.cells.charts/series) | Системный объект, который нужно найти. Значение может быть null.|
