...
type: docs
weight: 60
url: /ru/aspose.cells.slicers/slicercache/slicer_cache_items/
is_root: false
---
##  slicer_cache_items недвижимость

Возвращает коллекцию SlicerCacheItem, содержащую все элементы кэша слайсера. Только для чтения.
