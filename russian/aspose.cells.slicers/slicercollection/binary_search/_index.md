...
type: docs
weight: 30
url: /ru/aspose.cells.slicers/slicercollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`Slicer`](/cells/python-net/ru/aspose.cells.slicers/slicer) | Системный объект, который нужно найти. Значение может быть null.|
