...
type: docs
weight: 20
url: /ru/aspose.cells.slicers/slicercacheitemcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`SlicerCacheItem`](/cells/python-net/ru/aspose.cells.slicers/slicercacheitem) | Системный объект, который нужно найти. Значение может быть null.|
