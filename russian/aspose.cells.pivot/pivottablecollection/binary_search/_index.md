...
type: docs
weight: 30
url: /ru/aspose.cells.pivot/pivottablecollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`PivotTable`](/cells/python-net/ru/aspose.cells.pivot/pivottable) | Системный объект, который нужно найти. Значение может быть null.|
