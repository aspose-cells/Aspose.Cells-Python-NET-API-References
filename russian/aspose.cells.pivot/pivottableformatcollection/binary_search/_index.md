...
type: docs
weight: 30
url: /ru/aspose.cells.pivot/pivottableformatcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`PivotTableFormat`](/cells/python-net/ru/aspose.cells.pivot/pivottableformat) | Системный объект, который нужно найти. Значение может быть null.|
