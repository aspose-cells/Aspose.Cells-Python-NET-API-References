...
type: docs
weight: 30
url: /ru/aspose.cells.drawing/picturecollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`Picture`](/cells/python-net/ru/aspose.cells.drawing/picture) | Системный объект, который нужно найти. Значение может быть null.|
