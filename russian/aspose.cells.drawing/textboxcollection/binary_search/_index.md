...
type: docs
weight: 30
url: /ru/aspose.cells.drawing/textboxcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`TextBox`](/cells/python-net/ru/aspose.cells.drawing/textbox) | Системный объект, который нужно найти. Значение может быть null.|
