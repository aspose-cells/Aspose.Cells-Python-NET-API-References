...
type: docs
weight: 30
url: /ru/aspose.cells.drawing/oleobjectcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`OleObject`](/cells/python-net/ru/aspose.cells.drawing/oleobject) | Системный объект, который нужно найти. Значение может быть null.|
