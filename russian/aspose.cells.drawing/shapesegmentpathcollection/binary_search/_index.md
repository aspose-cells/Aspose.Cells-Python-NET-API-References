...
type: docs
weight: 30
url: /ru/aspose.cells.drawing/shapesegmentpathcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`ShapeSegmentPath`](/cells/python-net/ru/aspose.cells.drawing/shapesegmentpath) | Системный объект, который нужно найти. Значение может быть null.|
