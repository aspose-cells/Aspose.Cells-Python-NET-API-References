...
type: docs
weight: 1020
url: /ru/aspose.cells.drawing/msopresettexteffect/
is_root: false
---
##  MsoPresetTextEffect перечисление
Представляет собой предустановленный тип текстового эффекта WordArt.



Тип MsoPresetTextEffect предоставляет следующие элементы:
