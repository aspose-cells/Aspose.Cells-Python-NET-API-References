...
type: docs
weight: 30
url: /ru/aspose.cells.timelines/timelinecollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`Timeline`](/cells/python-net/ru/aspose.cells.timelines/timeline) | Системный объект, который нужно найти. Значение может быть null.|
