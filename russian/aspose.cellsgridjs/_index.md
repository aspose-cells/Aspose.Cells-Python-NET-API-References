...
type: docs
weight: 10
url: /ru/aspose.cellsgridjs/
is_root: false
---
**Aspose.Cells.GridJs** Пространство имен содержит все классы GridJ, которые обеспечивают основные операции по управлению электронными таблицами без использования Microsoft Excel.
...
| :- | :- |
| [`GridExceptionType`](/cells/python-net/ru/aspose.cellsgridjs/gridexceptiontype) | Представляет пользовательский код исключения для GridJ.|
| [`GridLoadFormat`](/cells/python-net/ru/aspose.cellsgridjs/gridloadformat) | Представляет формат загружаемого файла.|
