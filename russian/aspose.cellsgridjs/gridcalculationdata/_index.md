---
title: GridCalculationData класс
second_title: Aspose.Cells.GridJs for Python via .NET API
description:
type: docs
weight: 40
url: /ru/aspose.cellsgridjs/gridcalculationdata/
is_root: false
---
##  GridCalculationData класс

Представляет необходимые данные при вычислении одной функции, такие как имя функции, параметры и т. д.



Тип GridCalculationData предоставляет следующие элементы:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [calculated_value](/cells/python-net/ru/aspose.cellsgridjs/gridcalculationdata/calculated_value) | Получает/устанавливает расчетное значение для этой функции.|
| [row](/cells/python-net/ru/aspose.cellsgridjs/gridcalculationdata/row) | Получает индекс строки Cell, в которой находится функция.|
