...
type: docs
weight: 20
url: /ru/aspose.cells.properties/builtindocumentpropertycollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`DocumentProperty`](/cells/python-net/ru/aspose.cells.properties/documentproperty) | Системный объект, который нужно найти. Значение может быть null.|
