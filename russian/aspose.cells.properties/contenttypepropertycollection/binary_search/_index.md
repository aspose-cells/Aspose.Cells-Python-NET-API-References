...
type: docs
weight: 30
url: /ru/aspose.cells.properties/contenttypepropertycollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`ContentTypeProperty`](/cells/python-net/ru/aspose.cells.properties/contenttypeproperty) | Системный объект, который нужно найти. Значение может быть null.|
