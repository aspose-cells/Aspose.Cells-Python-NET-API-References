...
type: docs
weight: 240
url: /ru/aspose.cells.rendering/svgimageoptions/only_area/
is_root: false
---
##  only_area недвижимость

Если это свойство имеет значение true, будет выведена одна область, и масштабирование не применяется.
###  Определение:
```python
@property
def only_area(self):
