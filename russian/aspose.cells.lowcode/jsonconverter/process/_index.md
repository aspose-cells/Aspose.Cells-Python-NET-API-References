...
type: docs
weight: 20
url: /ru/aspose.cells.lowcode/jsonconverter/process/
is_root: false
---
##  process(, файл_шаблона, файл_результата){#str-str}
Конвертирует заданный файл шаблона между json и другими форматами.
...
Конвертирует данные JSON в другие форматы файлов электронных таблиц и обратно.
...
* класс [`JsonConverter`](/cells/python-net/ru/aspose.cells.lowcode/jsonconverter)
