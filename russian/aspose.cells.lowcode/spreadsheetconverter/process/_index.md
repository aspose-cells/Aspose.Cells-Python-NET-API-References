...
type: docs
weight: 20
url: /ru/aspose.cells.lowcode/spreadsheetconverter/process/
is_root: false
---
##  process(, файл_шаблона, файл_результата){#str-str}
Конвертирует заданный файл шаблона между форматами файлов электронных таблиц.
...
| :- | :- | :- |
| template_file | str | Файл шаблона для преобразования|
...
Конвертирует файлы электронных таблиц между различными форматами.
...
* класс [`SpreadsheetConverter`](/cells/python-net/ru/aspose.cells.lowcode/spreadsheetconverter)
