...
type: docs
weight: 20
url: /ru/aspose.cells.lowcode/htmlconverter/process/
is_root: false
---
##  process(, файл_шаблона, файл_результата){#str-str}
Конвертирует заданный файл шаблона между html и другими форматами.
...
Конвертирует файлы между HTML и другими форматами электронных таблиц.
...
* класс [`HtmlConverter`](/cells/python-net/ru/aspose.cells.lowcode/htmlconverter)
