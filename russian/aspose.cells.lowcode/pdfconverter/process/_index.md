...
type: docs
weight: 20
url: /ru/aspose.cells.lowcode/pdfconverter/process/
is_root: false
---
##  process(, файл_шаблона, файл_результата){#str-str}
Конвертирует заданный файл шаблона в PDF.
...
* класс [`PdfConverter`](/cells/python-net/ru/aspose.cells.lowcode/pdfconverter)
