...
type: docs
weight: 30
url: /ru/aspose.cells.tables/listobjectcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`ListObject`](/cells/python-net/ru/aspose.cells.tables/listobject) | Системный объект, который нужно найти. Значение может быть null.|
