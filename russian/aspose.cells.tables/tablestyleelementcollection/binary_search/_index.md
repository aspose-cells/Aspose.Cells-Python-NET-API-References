...
type: docs
weight: 30
url: /ru/aspose.cells.tables/tablestyleelementcollection/binary_search/
is_root: false
---
...
| :- | :- | :- |
| item | [`TableStyleElement`](/cells/python-net/ru/aspose.cells.tables/tablestyleelement) | Системный объект, который нужно найти. Значение может быть null.|
