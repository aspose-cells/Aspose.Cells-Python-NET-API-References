---
title: método custom_print
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 20
url: /es/aspose.cells.rendering/sheetrender/custom_print/
is_root: false
---
##  custom_print(self, next_page_after_print, print_page_event_args) {#bool-aspose.pydrawing.printing.PrintPageEventArgs}
El cliente puede controlar la configuración de la página de la impresora al imprimir cada página utilizando esta función.
...
| :- | :- | :- |
| next_page_after_print | bool | Si es verdadero, la impresora pasará a la página siguiente después de imprimir la página actual|
