...
| display_as_icon | bool | Indica si se muestra el objeto como un icono.<br/> Si es verdadero, los datos de la imagen original quedarán cubiertos por el icono.|
| label | str | La etiqueta del icono solo funciona cuando el valor de displayAsIcon es verdadero.|
