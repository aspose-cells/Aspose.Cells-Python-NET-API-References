...
type: docs
weight: 250
url: /es/aspose.cells.properties/builtindocumentpropertycollection/last_printed_universal_time/
is_root: false
---
##  last_printed_universal_time propiedad

Obtiene o establece la hora universal en la que se imprimió el documento por última vez.
###  Definición:
```python
@property
