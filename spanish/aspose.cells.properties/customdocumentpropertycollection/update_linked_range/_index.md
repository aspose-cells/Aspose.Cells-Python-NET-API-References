---
title: método update_linked_range
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 100
url: /es/aspose.cells.properties/customdocumentpropertycollection/update_linked_range/
is_root: false
---
##  update_linked_range(self) {#}
Actualizar el valor de la propiedad del documento personalizado al rango vinculado.
