...
type: docs
weight: 70
url: /es/aspose.cells.tables/listobject/resize/
is_root: false
---
##  resize(self, start_row, start_column, end_row, end_column, has_headers) {#int-int-int-int-bool}
Cambiar el tamaño del rango del objeto de lista.
...
| :- | :- | :- |
| start_row | int | El índice de la fila inicial del nuevo rango.|
| start_column | int | El índice de la columna de inicio del nuevo rango.|
| end_row | int | El índice de la fila final del nuevo rango.|
| end_column | int | El índice de la columna final del nuevo rango.|
| has_headers | bool | Si esta tabla tiene encabezados.|
