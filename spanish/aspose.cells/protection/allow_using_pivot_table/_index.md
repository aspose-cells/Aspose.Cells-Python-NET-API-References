...
type: docs
weight: 210
url: /es/aspose.cells/protection/allow_using_pivot_table/
is_root: false
---
##  allow_using_pivot_table propiedad

Representa si al usuario se le permite manipular tablas dinámicas en una hoja de trabajo protegida.
###  Definición:
```python
@property
