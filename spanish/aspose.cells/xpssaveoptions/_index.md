...
| :- | :- |
| [XpsSaveOptions()](/cells/python-net/es/aspose.cells/xpssaveoptions/__init__/#) | Crea opciones para guardar el archivo xps.|
| [XpsSaveOptions(save_format)](/cells/python-net/es/aspose.cells/xpssaveoptions/__init__/#SaveFormat) | Crea opciones para guardar el archivo xps.|


###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [save_format](/cells/python-net/es/aspose.cells/xpssaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/python-net/es/aspose.cells/xpssaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
...
| [sort_names](/cells/python-net/es/aspose.cells/xpssaveoptions/sort_names) | Indica si ordenar los nombres definidos antes de guardar el archivo.|
| [sort_external_names](/cells/python-net/es/aspose.cells/xpssaveoptions/sort_external_names) |Indica si ordenar los nombres definidos externos antes de guardar el archivo.|
| [refresh_chart_cache](/cells/python-net/es/aspose.cells/xpssaveoptions/refresh_chart_cache) | Indica si se actualizan los datos de la memoria caché del gráfico|
...
| [update_smart_art](/cells/python-net/es/aspose.cells/xpssaveoptions/update_smart_art) | Indica si se está actualizando la configuración de arte inteligente.<br/> El valor predeterminado es falso.|
...
| [check_font_compatibility](/cells/python-net/es/aspose.cells/xpssaveoptions/check_font_compatibility) |Indica si se debe comprobar la compatibilidad de fuentes para cada carácter del texto.|
| [is_font_substitution_char_granularity](/cells/python-net/es/aspose.cells/xpssaveoptions/is_font_substitution_char_granularity) | Indica si solo se sustituye la fuente del carácter cuando la fuente de la celda no es compatible con él.|
| [one_page_per_sheet](/cells/python-net/es/aspose.cells/xpssaveoptions/one_page_per_sheet) | Si OnePagePerSheet es verdadero, todo el contenido de una hoja se generará en una sola página como resultado.<br/> El tamaño de papel de configuración de página no será válido, y las otras configuraciones de configuración de página<br/> aún tendrá efecto.|
...
| [output_blank_page_when_nothing_to_print](/cells/python-net/es/aspose.cells/xpssaveoptions/output_blank_page_when_nothing_to_print) | Indica si imprimir una página en blanco cuando no hay nada que imprimir.|
| [page_index](/cells/python-net/es/aspose.cells/xpssaveoptions/page_index) | Obtiene o establece el índice basado en 0 de la primera página que se va a guardar.|
| [page_count](/cells/python-net/es/aspose.cells/xpssaveoptions/page_count) | Obtiene o establece el número de páginas que se van a guardar.|
...
| [text_cross_type](/cells/python-net/es/aspose.cells/xpssaveoptions/text_cross_type) | Obtiene o establece el tipo de texto que se muestra cuando el ancho del texto es mayor que el ancho de la celda.|
...
| [sheet_set](/cells/python-net/es/aspose.cells/xpssaveoptions/sheet_set) |Obtiene o establece las hojas para representar. El valor predeterminado es todas las hojas visibles en el libro de trabajo: [SheetSet.visible](/cells/python-net/es/aspose.cells.rendering/sheetset#visible).|
