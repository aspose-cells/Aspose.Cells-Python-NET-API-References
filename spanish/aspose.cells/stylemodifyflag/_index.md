...
| CELL_SHADING | Indica si una o más propiedades relacionadas con el sombreado ([StyleModifyFlag.PATTERN](/cells/python-net/es/aspose.cells/stylemodifyflag#PATTERN),<br/> [StyleModifyFlag.FOREGROUND_COLOR](/cells/python-net/es/aspose.cells/stylemodifyflag#FOREGROUND_COLOR), [StyleModifyFlag.BACKGROUND_COLOR](/cells/python-net/es/aspose.cells/stylemodifyflag#BACKGROUND_COLOR)) se han modificado.|
