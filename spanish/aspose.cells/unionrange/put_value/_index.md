...
type: docs
weight: 60
url: /es/aspose.cells/unionrange/put_value/
is_root: false
---
##  put_value(self, string_value, is_converted, set_style) {#str-bool-bool}
Coloca un valor en el rango, si corresponde, el valor se convertirá a otro tipo de datos y se restablecerá el formato de número de la celda.
