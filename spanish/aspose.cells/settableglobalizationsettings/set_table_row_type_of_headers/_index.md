---
title: método set_table_row_type_of_headers
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 430
url: /es/aspose.cells/settableglobalizationsettings/set_table_row_type_of_headers/
is_root: false
---
##  set_table_row_type_of_headers(self, name) {#str}
Establece el nombre del tipo de filas de la tabla que constan del encabezado de la tabla.
