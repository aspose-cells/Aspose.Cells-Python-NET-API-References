...
type: docs
weight: 120
url: /es/aspose.cells/settableglobalizationsettings/get_local_built_in_name/
is_root: false
---
##  get_local_built_in_name(self, standard_name) {#str}
Obtiene el texto dependiente de la configuración regional para el nombre incorporado de acuerdo con el texto estándar dado.
...
| :- | :- | :- |
| standard_name | str | Texto estándar (configuración regional en-US) del nombre incorporado.|
