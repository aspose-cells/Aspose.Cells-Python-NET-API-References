...
| :- | :- |
| [`__init__(self)`](/cells/python-net/es/aspose.cells/cellarea/__init__/#) | Construye una nueva instancia de CellArea|


###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [start_row](/cells/python-net/es/aspose.cells/cellarea/start_row) | Obtiene o establece la fila de inicio de esta área.|
| [end_row](/cells/python-net/es/aspose.cells/cellarea/end_row) | Obtiene o establece la fila final de esta área.|
...
| [`compare_to(self, obj)`](/cells/python-net/es/aspose.cells/cellarea/compare_to/#any) | Compare dos objetos CellArea según su esquina superior izquierda.|
