---
title: método get_range_by_name
...
Obtiene [`Range`](/cells/python-net/es/aspose.cells/range) por nombre predefinido o nombre de la tabla
...
| include_table | bool | Indica si se deben comprobar todas las tablas.|
