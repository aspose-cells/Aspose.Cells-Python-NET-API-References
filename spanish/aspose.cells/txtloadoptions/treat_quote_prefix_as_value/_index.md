...
type: docs
weight: 420
url: /es/aspose.cells/txtloadoptions/treat_quote_prefix_as_value/
is_root: false
---
...
El valor predeterminado es verdadero. Si es falso, se eliminará la comilla simple inicial del valor de la celda correspondiente.
y [`Style.quote_prefix`](/cells/python-net/es/aspose.cells/style#quote_prefix) se establecerá como verdadero para la celda.
###  Definición:
```python
@property
