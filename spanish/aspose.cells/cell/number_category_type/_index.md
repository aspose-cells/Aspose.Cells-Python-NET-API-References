...
Cuando el patrón de formato de la celda se combina con patrones de formato condicional,
...
luego, cuando el valor de la celda es numérico y no 0, el tipo devuelto es [`NumberCategoryType.NUMBER`](/cells/python-net/es/aspose.cells/numbercategorytype#NUMBER);
