---
title: método set_outline_border
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 240
url: /es/aspose.cells/range/set_outline_border/
is_root: false
---
...
Establece un borde de contorno alrededor de un rango de celdas.
...
| :- | :- | :- |
| border_edge | [`BorderType`](/cells/python-net/es/aspose.cells/bordertype) | Borde del borde.|
