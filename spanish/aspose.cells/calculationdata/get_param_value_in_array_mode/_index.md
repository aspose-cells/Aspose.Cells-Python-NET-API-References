...
Si el parámetro es algún tipo de expresión que debe calcularse,
...
En el modo de valor, se calculará en un valor único según la base de celda actual.
Pero en el modo de matriz, todos los valores de A1+B1,A2+B2,A3+B3,... se calcularán y utilizarán para construir la matriz devuelta.
Y para este tipo de situación, es mejor especificar el límite para el recuento de filas/columnas.
...
de lo contrario, la matriz grande devuelta puede aumentar el costo de la memoria con una gran cantidad de datos inútiles.
