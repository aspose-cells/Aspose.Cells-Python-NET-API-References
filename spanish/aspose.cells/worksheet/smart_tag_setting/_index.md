...
type: docs
weight: 780
url: /es/aspose.cells/worksheet/smart_tag_setting/
is_root: false
---
##  smart_tag_setting propiedad

Obtiene todos los [`SmartTagCollection`](/cells/python-net/es/aspose.cells.markup/smarttagcollection) objetos de la hoja de trabajo.
###  Definición:
```python
@property
