...
| :- | :- |
| [save_format](/cells/python-net/es/aspose.cells/paginatedsaveoptions/save_format) | Obtiene el formato del archivo guardado.|
| [clear_data](/cells/python-net/es/aspose.cells/paginatedsaveoptions/clear_data) | Deje el libro vacío después de guardar el archivo.|
...
| [sort_names](/cells/python-net/es/aspose.cells/paginatedsaveoptions/sort_names) | Indica si se ordenan los nombres definidos antes de guardar el archivo.|
| [sort_external_names](/cells/python-net/es/aspose.cells/paginatedsaveoptions/sort_external_names) | Indica si se ordenan los nombres externos definidos antes de guardar el archivo.|
| [refresh_chart_cache](/cells/python-net/es/aspose.cells/paginatedsaveoptions/refresh_chart_cache) | Indica si se actualizan los datos de la caché del gráfico.|
...
| [update_smart_art](/cells/python-net/es/aspose.cells/paginatedsaveoptions/update_smart_art) | Indica si se actualiza la configuración de arte inteligente.<br/> El valor predeterminado es falso.|
...
| [check_font_compatibility](/cells/python-net/es/aspose.cells/paginatedsaveoptions/check_font_compatibility) | Indica si se debe verificar la compatibilidad de fuentes para cada carácter del texto.|
| [is_font_substitution_char_granularity](/cells/python-net/es/aspose.cells/paginatedsaveoptions/is_font_substitution_char_granularity) |Indica si solo se debe sustituir la fuente del carácter cuando la fuente de la celda no sea compatible con él.|
| [one_page_per_sheet](/cells/python-net/es/aspose.cells/paginatedsaveoptions/one_page_per_sheet) | Si OnePagePerSheet es verdadero, todo el contenido de una hoja se generará en una sola página.<br/> El tamaño del papel de pagesetup no será válido y las demás configuraciones de pagesetup<br/> seguirá surtiendo efecto.|
...
| [output_blank_page_when_nothing_to_print](/cells/python-net/es/aspose.cells/paginatedsaveoptions/output_blank_page_when_nothing_to_print) | Indica si se debe generar una página en blanco cuando no hay nada que imprimir.|
| [page_index](/cells/python-net/es/aspose.cells/paginatedsaveoptions/page_index) | Obtiene o establece el índice basado en 0 de la primera página que se guardará.|
| [page_count](/cells/python-net/es/aspose.cells/paginatedsaveoptions/page_count) | Obtiene o establece el número de páginas que se guardarán.|
...
| [text_cross_type](/cells/python-net/es/aspose.cells/paginatedsaveoptions/text_cross_type) | Obtiene o establece la visualización del tipo de texto cuando el ancho del texto es mayor que el ancho de la celda.|
...
| [sheet_set](/cells/python-net/es/aspose.cells/paginatedsaveoptions/sheet_set) |Obtiene o establece las hojas que se van a representar. El valor predeterminado son todas las hojas visibles del libro: [`SheetSet.visible`](/cells/python-net/es/aspose.cells.rendering/sheetset#visible).|
...
| [emf_render_setting](/cells/python-net/es/aspose.cells/paginatedsaveoptions/emf_render_setting) | Configuración para renderizar el metarchivo Emf.|
