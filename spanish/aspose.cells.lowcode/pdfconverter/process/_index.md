...
type: docs
weight: 20
url: /es/aspose.cells.lowcode/pdfconverter/process/
is_root: false
---
##  process(, archivo_de_plantilla, archivo_de_resultados){#str-str}
Convierte el archivo de plantilla dado a PDF.
...
| result_file | str |El archivo resultante debe ser un archivo pdf.|
...
Convierte el archivo de plantilla a PDF
...
* clase [`PdfConverter`](/cells/python-net/es/aspose.cells.lowcode/pdfconverter)
