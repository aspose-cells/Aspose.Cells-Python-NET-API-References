...
type: docs
weight: 20
url: /es/aspose.cells.lowcode/textconverter/process/
is_root: false
---
##  process(, archivo_de_plantilla, archivo_de_resultados){#str-str}
Convierte el archivo de plantilla dado entre archivos basados en texto y otros formatos.
...
| :- | :- | :- |
| template_file | str | El archivo de plantilla que se va a convertir|
...
Convierte formatos de archivo entre formatos basados en texto y otros formatos de archivos de hojas de cálculo
...
* clase [`TextConverter`](/cells/python-net/es/aspose.cells.lowcode/textconverter)
