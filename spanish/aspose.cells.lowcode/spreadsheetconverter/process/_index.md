...
type: docs
weight: 20
url: /es/aspose.cells.lowcode/spreadsheetconverter/process/
is_root: false
---
##  process(, archivo_de_plantilla, archivo_de_resultados){#str-str}
Convierte el archivo de plantilla dado entre formatos de archivos de hoja de cálculo.
...
* clase [`SpreadsheetConverter`](/cells/python-net/es/aspose.cells.lowcode/spreadsheetconverter)
