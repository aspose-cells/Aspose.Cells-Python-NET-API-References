...
type: docs
weight: 20
url: /es/aspose.cells.lowcode/htmlconverter/process/
is_root: false
---
##  process(, archivo_de_plantilla, archivo_de_resultados){#str-str}
Convierte el archivo de plantilla dado entre HTML y otros formatos.
...
Convierte archivos entre HTML y otros formatos de archivos de hojas de cálculo.
...
* clase [`HtmlConverter`](/cells/python-net/es/aspose.cells.lowcode/htmlconverter)
