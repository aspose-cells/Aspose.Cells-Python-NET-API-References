---
title: EquationMathematicalOperatorType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 260
url: /es/aspose.cells.drawing.equations/equationmathematicaloperatortype/
is_root: false
---
##  EquationMathematicalOperatorType enumeración
Tipos de operadores matemáticos



El tipo EquationMathematicalOperatorType expone los siguientes miembros:

###  Campos
| Campo| Descripción|
| :- | :- |
| UNKNOWN | Utilice un tipo desconocido cuando no se encuentre en el tipo existente.|
| FOR_ALL | "∀" Unicode:\u2200|
| COMPLEMENT | "∁" Unicode:\u2201|
