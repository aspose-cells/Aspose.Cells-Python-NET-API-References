...
type: docs
weight: 270
url: /es/aspose.cells.externalconnections/webqueryconnection/parameters/
is_root: false
---
##  parameters propiedad

Obtiene [ConnectionParameterCollection](/cells/python-net/es/aspose.cells.externalconnections/connectionparametercollection) para una consulta web o ODBC.
###  Definición:
```python
@property
def parameters(self):
