...
| [auto_scale_font](/cells/python-net/es/aspose.cells.charts/chartdatatable/auto_scale_font) | True si el texto del objeto cambia el tamaño de fuente cuando cambia el tamaño del objeto.<br/> El valor por defecto es verdadero.|
...
| [show_legend_key](/cells/python-net/es/aspose.cells.charts/chartdatatable/show_legend_key) | True si la clave de la leyenda de la etiqueta de datos está visible.|
