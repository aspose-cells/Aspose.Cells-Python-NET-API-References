---
title: inner_x_ratio_to_chart propiedad
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 260
url: /es/aspose.cells.charts/plotarea/inner_x_ratio_to_chart/
is_root: false
---
##  inner_x_ratio_to_chart propiedad
...
InnerX en píxeles = InnerXRatioToChart * chart.ChartObject.Width.
###  Definición:
```python
@property
