...
type: docs
weight: 410
url: /es/aspose.cells.charts/plotarea/x_ratio_to_chart/
is_root: false
---
##  x_ratio_to_chart propiedad

Obtiene u obtiene la coordenada x de la esquina superior izquierda del cuadro delimitador del área del gráfico en unidades de relación del área del gráfico.
...
XPixel = XRatioToChart * gráfico.ChartObject.Width.
###  Definición:
```python
@property
