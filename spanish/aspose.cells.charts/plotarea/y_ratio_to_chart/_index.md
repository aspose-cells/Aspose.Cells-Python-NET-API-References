...
type: docs
weight: 440
url: /es/aspose.cells.charts/plotarea/y_ratio_to_chart/
is_root: false
---
##  y_ratio_to_chart propiedad

Obtiene u obtiene la coordenada y de la esquina superior del cuadro delimitador del área del gráfico en unidades de relación con el área del gráfico.
...
YPixel = YRatioToChart * gráfico.ChartObject.Width.
###  Definición:
```python
@property
