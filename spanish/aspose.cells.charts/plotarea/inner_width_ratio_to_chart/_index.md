---
title: inner_width_ratio_to_chart propiedad
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 240
url: /es/aspose.cells.charts/plotarea/inner_width_ratio_to_chart/
is_root: false
---
##  inner_width_ratio_to_chart propiedad

Obtiene o establece el ancho del área del gráfico en unidades de relación con el área del gráfico.
...
InnerWidth en Pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Definición:
```python
@property
