...
type: docs
weight: 250
url: /es/aspose.cells.charts/plotarea/inner_x/
is_root: false
---
##  inner_x propiedad

Obtiene u obtiene la coordenada x de la esquina superior del área del gráfico en unidades de 1/4000 del área del gráfico.
