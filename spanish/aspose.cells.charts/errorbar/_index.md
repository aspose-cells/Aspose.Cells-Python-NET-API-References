...
| [weight_pt](/cells/python-net/es/aspose.cells.charts/errorbar/weight_pt) | Obtiene o establece el grosor de la línea en unidades de puntos.|
...
| [show_marker_t_top](/cells/python-net/es/aspose.cells.charts/errorbar/show_marker_t_top) | Indica si hay barras de error de formato con una T-top.|
...
| [minus_value](/cells/python-net/es/aspose.cells.charts/errorbar/minus_value) | Representa la cantidad de error negativa cuando el tipo de barra de error es Personalizado.|
