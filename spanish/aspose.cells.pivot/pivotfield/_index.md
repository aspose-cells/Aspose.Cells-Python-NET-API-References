...
| :- | :- |
| [pivot_items](/cells/python-net/es/aspose.cells.pivot/pivotfield/pivot_items) | Obtiene los elementos dinámicos del campo dinámico.|
| [range](/cells/python-net/es/aspose.cells.pivot/pivotfield/range) | Obtiene el rango de grupo del campo dinámico|
| [group_settings](/cells/python-net/es/aspose.cells.pivot/pivotfield/group_settings) | Obtiene la configuración de grupo del campo dinámico.|
...
| [position](/cells/python-net/es/aspose.cells.pivot/pivotfield/position) | Representa el índice de [`PivotField`](/cells/python-net/es/aspose.cells.pivot/pivotfield) en la región.|
...
| [drag_to_hide](/cells/python-net/es/aspose.cells.pivot/pivotfield/drag_to_hide) | Indica si el campo especificado se puede arrastrar a la posición de ocultar.<br/> El valor por defecto es verdadero.|
...
| [show_all_items](/cells/python-net/es/aspose.cells.pivot/pivotfield/show_all_items) | Indica si todos los elementos se muestran en el informe de tabla dinámica.<br/>incluso si no contienen datos resumidos.<br/>mostrar elementos sin datos<br/> El valor predeterminado es falso.|
...
| [auto_show_count](/cells/python-net/es/aspose.cells.pivot/pivotfield/auto_show_count) | Representa el número de elementos superiores o inferiores.<br/> que se muestran automáticamente en el campo de tabla dinámica especificado.|
| [auto_show_field](/cells/python-net/es/aspose.cells.pivot/pivotfield/auto_show_field) | Representa el índice del campo de exhibición automática. -1 significa el propio PivotField.<br/> Debería ser el índice de los campos de datos.|
...
| [current_page_item](/cells/python-net/es/aspose.cells.pivot/pivotfield/current_page_item) | Representa el elemento de la página actual que se muestra para el campo de página (válido solo para campos de página).|
...
| [show_in_outline_form](/cells/python-net/es/aspose.cells.pivot/pivotfield/show_in_outline_form) | Indica si se presenta este campo en forma de esquema en la vista de tabla dinámica.|
...
| [items](/cells/python-net/es/aspose.cells.pivot/pivotfield/items) | Obtenga todos los elementos básicos;|
...
| Método| Descripción|
| :- | :- |
| [group_by](/cells/python-net/es/aspose.cells.pivot/pivotfield/group_by/#float-bool) | Agrupa automáticamente el campo con interno.|
| [group_by](/cells/python-net/es/aspose.cells.pivot/pivotfield/group_by/#DateTime-DateTime-list-float-bool) | Agrupe el archivo por tipos de grupos de fechas.|
| [group_by](/cells/python-net/es/aspose.cells.pivot/pivotfield/group_by/#float-float-float-bool) |Agrupe el archivo por número.|
| [group_by](/cells/python-net/es/aspose.cells.pivot/pivotfield/group_by/#list-bool) | Grupo personalizado del campo.|
| [hide_item](/cells/python-net/es/aspose.cells.pivot/pivotfield/hide_item/#int-bool) | Establece si el PivotItem específico en un campo de datos está oculto.|
| [hide_item](/cells/python-net/es/aspose.cells.pivot/pivotfield/hide_item/#str-bool) | Establece si el PivotItem específico en un campo de datos está oculto.|
| [get_pivot_filter_by_type](/cells/python-net/es/aspose.cells.pivot/pivotfield/get_pivot_filter_by_type/#aspose.cells.pivot.PivotFilterType) | Obtiene el filtro dinámico del campo dinámico por tipo|
| [get_pivot_filters](/cells/python-net/es/aspose.cells.pivot/pivotfield/get_pivot_filters/#) | Obtiene los filtros de pivote del campo de pivote.|
| [get_filters](/cells/python-net/es/aspose.cells.pivot/pivotfield/get_filters/#) | Obtiene todos los filtros dinámicos de este campo dinámico.|
| [init_pivot_items](/cells/python-net/es/aspose.cells.pivot/pivotfield/init_pivot_items/#) | Inicie los elementos dinámicos del campo dinámico|
| [ungroup](/cells/python-net/es/aspose.cells.pivot/pivotfield/ungroup/#) | Desagrupe el campo dinámico.|
...
| [set_subtotals](/cells/python-net/es/aspose.cells.pivot/pivotfield/set_subtotals/#aspose.cells.pivot.PivotFieldSubtotalType-bool) | Establece si el campo especificado muestra esos subtotales.|
| [get_subtotals](/cells/python-net/es/aspose.cells.pivot/pivotfield/get_subtotals/#aspose.cells.pivot.PivotFieldSubtotalType) | Indica si se muestra el subtotal especificado.|
| [is_hidden_item](/cells/python-net/es/aspose.cells.pivot/pivotfield/is_hidden_item/#int) | Indica si el PivotItem específico está oculto.|
| [is_hidden_item_detail](/cells/python-net/es/aspose.cells.pivot/pivotfield/is_hidden_item_detail/#int) | Indica si el PivotItem específico es un detalle oculto.|
| [hide_item_detail](/cells/python-net/es/aspose.cells.pivot/pivotfield/hide_item_detail/#int-bool) | Establece si el PivotItem específico en un campo dinámico es un detalle oculto.|
| [hide_detail](/cells/python-net/es/aspose.cells.pivot/pivotfield/hide_detail/#bool) | Establece si los elementos dinámicos en un campo dinámico son detalles ocultos. Es decir, contraer/expandir este campo.|
| [add_calculated_item](/cells/python-net/es/aspose.cells.pivot/pivotfield/add_calculated_item/#str-str) | Agregue un elemento calculado al campo dinámico.|
