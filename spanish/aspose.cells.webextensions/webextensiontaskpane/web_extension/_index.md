...
type: docs
weight: 70
url: /es/aspose.cells.webextensions/webextensiontaskpane/web_extension/
is_root: false
---
##  web_extension propiedad

Obtiene y establece la parte de extensión web asociada con la instancia del panel de tareas
###  Definición:
```python
@property
