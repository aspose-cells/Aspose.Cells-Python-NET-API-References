---
title: GridCalculationData clase
second_title: Aspose.Cells.GridJs for Python via .NET API Referencias
description:
type: docs
weight: 40
url: /es/aspose.cellsgridjs/gridcalculationdata/
is_root: false
---
##  GridCalculationData clase

Representa los datos requeridos al calcular una función, como el nombre de la función, parámetros, etc.



El tipo GridCalculationData expone los siguientes miembros:

###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [calculated_value](/cells/python-net/es/aspose.cellsgridjs/gridcalculationdata/calculated_value) | Obtiene/establece el valor calculado para esta función.|
| [row](/cells/python-net/es/aspose.cellsgridjs/gridcalculationdata/row) | Obtiene el índice de fila Cell donde se encuentra la función.|
