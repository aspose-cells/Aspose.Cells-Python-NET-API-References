...
[`TextBox`](/cells/python-net/tr/aspose.cells.drawing/textbox) nesnesi.
...
| top | int | Metin kutusunun en üst satırından itibaren dikey uzaklığını piksel cinsinden temsil eder.|
...
| height | int | Metin kutusunun yüksekliğini piksel cinsinden temsil eder.|
| width | int | Metin kutusunun genişliğini piksel cinsinden temsil eder.|
