---
title: left_crop_inch mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 110
url: /tr/aspose.cells.drawing/msoformatpicture/left_crop_inch/
is_root: false
---
##  left_crop_inch mülk

Mahsul dikdörtgeninin sol tarafının konumunu inç cinsinden ifade eder.
###  Tanım:
```python
@property
