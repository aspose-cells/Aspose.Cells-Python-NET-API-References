---
title: tiff_binarization_method mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 390
url: /tr/aspose.cells.rendering/svgimageoptions/tiff_binarization_method/
is_root: false
---
...
Varsayılan değer FloydSteinbergDithering'dir.
###  Tanım:
```python
@property
...
* sınıf [`ImageBinarizationMethod`](/cells/python-net/tr/aspose.cells.rendering/imagebinarizationmethod)
