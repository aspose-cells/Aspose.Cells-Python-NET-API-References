...
type: docs
weight: 20
url: /tr/aspose.cells.lowcode/textconverter/process/
is_root: false
---
##  process(, şablon_dosyası, sonuç_dosyası){#str-str}
Verilen şablon dosyasını metin tabanlı dosyalar ile diğer formatlar arasında dönüştürür.
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| template_file | str | Dönüştürülecek şablon dosyası|
...
Dosya biçimini metin tabanlı biçimler ile diğer elektronik tablo dosya biçimleri arasında dönüştürür
...
* sınıf [`TextConverter`](/cells/python-net/tr/aspose.cells.lowcode/textconverter)
