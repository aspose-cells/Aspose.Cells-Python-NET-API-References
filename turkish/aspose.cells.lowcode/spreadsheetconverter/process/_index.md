...
type: docs
weight: 20
url: /tr/aspose.cells.lowcode/spreadsheetconverter/process/
is_root: false
---
##  process(, şablon_dosyası, sonuç_dosyası){#str-str}
Verilen şablon dosyasını elektronik tablo dosya biçimleri arasında dönüştürür.
...
Farklı elektronik tablo dosya formatları arasında dönüşüm sağlar.
...
* sınıf [`SpreadsheetConverter`](/cells/python-net/tr/aspose.cells.lowcode/spreadsheetconverter)
