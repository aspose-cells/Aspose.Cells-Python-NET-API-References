...
type: docs
weight: 20
url: /tr/aspose.cells.lowcode/pdfconverter/process/
is_root: false
---
##  process(, şablon_dosyası, sonuç_dosyası){#str-str}
Verilen şablon dosyasını pdf'e dönüştürür.
...
| result_file | str |Ortaya çıkan dosyanın pdf dosyası olması gerekiyor.|
...
* sınıf [`PdfConverter`](/cells/python-net/tr/aspose.cells.lowcode/pdfconverter)
