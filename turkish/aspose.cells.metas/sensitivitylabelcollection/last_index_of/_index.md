...
type: docs
weight: 60
url: /tr/aspose.cells.metas/sensitivitylabelcollection/last_index_of/
is_root: false
---
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| item | [`SensitivityLabel`](/cells/python-net/tr/aspose.cells.metas/sensitivitylabel) | Dizi listesinde bulunacak nesne. Değeri null olabilir.|
...
###  Ayrıca bakınız
* modül [`aspose.cells.metas`](../../)
* sınıf [`SensitivityLabelCollection`](/cells/python-net/tr/aspose.cells.metas/sensitivitylabelcollection)
