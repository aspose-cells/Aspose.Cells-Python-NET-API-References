...
type: docs
weight: 410
url: /tr/aspose.cells.charts/plotarea/x_ratio_to_chart/
is_root: false
---
##  x_ratio_to_chart mülk

Grafik alanının oransal birimlerinde çizim alanı sınırlayıcı kutusunun sol üst köşesinin x koordinatını alır veya alır.
