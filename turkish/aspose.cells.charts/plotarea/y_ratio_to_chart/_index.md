...
type: docs
weight: 440
url: /tr/aspose.cells.charts/plotarea/y_ratio_to_chart/
is_root: false
---
##  y_ratio_to_chart mülk

Grafik alanının oransal birimlerinde, çizim alanı sınırlayıcı kutusunun üst köşesinin y koordinatını alır veya alır.
...
YPixel = YOranıGrafik * grafik.GrafikNesnesi.Genişliği.
###  Tanım:
```python
@property
