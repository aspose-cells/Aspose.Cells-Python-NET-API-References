---
title: inner_y_ratio_to_chart mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 280
url: /tr/aspose.cells.charts/plotarea/inner_y_ratio_to_chart/
is_root: false
---
##  inner_y_ratio_to_chart mülk

Grafik alanının oran birimi cinsinden arsa alanının üst köşesinin x koordinatını alır veya alır.
...
Pikseldeki InnerY = InnerYRatioToChart * chart.ChartObject.Width.
###  Tanım:
```python
@property
