---
title: inner_x_ratio_to_chart mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 260
url: /tr/aspose.cells.charts/plotarea/inner_x_ratio_to_chart/
is_root: false
---
##  inner_x_ratio_to_chart mülk
...
Pixel'de InnerX = InnerXRatioToChart * chart.ChartObject.Width.
###  Tanım:
```python
@property
