---
title: inner_height_ratio_to_chart mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 220
url: /tr/aspose.cells.charts/plotarea/inner_height_ratio_to_chart/
is_root: false
---
##  inner_height_ratio_to_chart mülk

Grafik alanının yüksekliğini grafik alanının oranına göre birimler halinde alır veya ayarlar.
...
Piksel cinsinden InnerHeight = InnerXRatioToChart * chart.ChartObject.Width.
###  Tanım:
```python
@property
