...
| Yapıcı| Tanım|
| :- | :- |
| [InterruptMonitor()](/cells/python-net/tr/aspose.cells/interruptmonitor/__init__/#) | InterruptMonitor'un yeni bir örneğini oluşturur|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [is_interruption_requested](/cells/python-net/tr/aspose.cells/interruptmonitor/is_interruption_requested) | Monitörü kesinti istiyor olarak işaretleyin|
...
| Yöntem| Tanım|
| :- | :- |
| [interrupt()](/cells/python-net/tr/aspose.cells/interruptmonitor/interrupt/#) | Mevcut operatörü kes.|
