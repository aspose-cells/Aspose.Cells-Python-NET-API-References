...
type: docs
weight: 50
url: /tr/aspose.cells/referredareacollection/last_index_of/
is_root: false
---
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| item | [`ReferredArea`](/cells/python-net/tr/aspose.cells/referredarea) | Dizi listesinde bulunacak nesne. Değeri null olabilir.|
...
###  Ayrıca bakınız
* modül [`aspose.cells`](../../)
* sınıf [`ReferredAreaCollection`](/cells/python-net/tr/aspose.cells/referredareacollection)
