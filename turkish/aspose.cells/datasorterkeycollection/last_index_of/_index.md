...
type: docs
weight: 50
url: /tr/aspose.cells/datasorterkeycollection/last_index_of/
is_root: false
---
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| item | [`DataSorterKey`](/cells/python-net/tr/aspose.cells/datasorterkey) | Dizi listesinde bulunacak nesne. Değeri null olabilir.|
...
###  Ayrıca bakınız
* modül [`aspose.cells`](../../)
* sınıf [`DataSorterKeyCollection`](/cells/python-net/tr/aspose.cells/datasorterkeycollection)
