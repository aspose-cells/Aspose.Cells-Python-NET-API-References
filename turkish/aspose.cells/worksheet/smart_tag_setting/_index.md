...
type: docs
weight: 760
url: /tr/aspose.cells/worksheet/smart_tag_setting/
is_root: false
---
##  smart_tag_setting mülk

Çalışma sayfasının tüm [SmartTagCollection](/cells/python-net/tr/aspose.cells.markup/smarttagcollection) nesnelerini alır.
###  Tanım:
```python
@property
