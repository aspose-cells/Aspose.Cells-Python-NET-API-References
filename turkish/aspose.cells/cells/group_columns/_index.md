...
type: docs
weight: 570
url: /tr/aspose.cells/cells/group_columns/
is_root: false
---
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| first_index | int | Gruplandırılacak ilk sütun indeksi.|
| last_index | int | Gruplandırılacak son sütun indeksi.|
...
| first_index | int | Gruplandırılacak ilk sütun indeksi.|
| last_index | int | Gruplandırılacak son sütun indeksi.|
| is_hidden | bool | Gruplanmış sütunların gizli olup olmadığını belirtir.|
