---
title: PivotDateTimeRangeGroupSettings sınıfı
...
**Miras:** [`PivotDateTimeRangeGroupSettings`](/cells/python-net/aspose.cells.pivot/pivotdatetimerangegroupsettings) → 
[`PivotFieldGroupSettings`](/cells/python-net/tr/aspose.cells.pivot/pivotfieldgroupsettings)



PivotDateTimeRangeGroupSettings türü aşağıdaki üyeleri ortaya çıkarır:
...
* sınıf [`PivotDateTimeRangeGroupSettings`](/cells/python-net/tr/aspose.cells.pivot/pivotdatetimerangegroupsettings)
