---
title: GridCalculationData sınıfı
second_title: Aspose.Cells.GridJs for Python via .NET API Referanslar
description:
type: docs
weight: 40
url: /tr/aspose.cellsgridjs/gridcalculationdata/
is_root: false
---
##  GridCalculationData sınıfı

Bir işlevi hesaplarken, işlev adı, parametreler vb. gibi gerekli verileri temsil eder.



GridCalculationData türü aşağıdaki üyeleri ortaya çıkarır:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [calculated_value](/cells/python-net/tr/aspose.cellsgridjs/gridcalculationdata/calculated_value) | Bu işlev için hesaplanan değeri alır/ayarlar.|
| [row](/cells/python-net/tr/aspose.cellsgridjs/gridcalculationdata/row) | İşlevin bulunduğu Cell Satır dizinini alır.|
