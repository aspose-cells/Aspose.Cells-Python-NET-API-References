...
| البناء| وصف|
| :- | :- |
| [FindOptions()](/cells/python-net/ar/aspose.cells/findoptions/__init__/#) | إنشاء مثيل جديد لـ FindOptions|
...
| [search_next](/cells/python-net/ar/aspose.cells/findoptions/search_next) | ترتيب البحث. صواب: ابحث بعد ذلك. خطأ: البحث السابق.|
...
| [regex_key](/cells/python-net/ar/aspose.cells/findoptions/regex_key) | يشير إلى ما إذا كان المفتاح الذي تم البحث عنه هو regex أم لا.<br/>إذا كان هذا صحيحًا ، فسيتم اعتبار المفتاح الذي تم البحث عنه كـ regex وتحليله. وإلا فسيتم تحليل المفتاح وفقًا للقواعد الواردة في ms excel.|
| [value_type_sensitive](/cells/python-net/ar/aspose.cells/findoptions/value_type_sensitive) | يشير إلى ما إذا كان يجب أن يكون نوع قيمة الخلية التي تم البحث عنها هو نفسه مع المفتاح الذي تم البحث عنه.|
...
| طريقة| وصف|
| :- | :- |
| [get_range()](/cells/python-net/ar/aspose.cells/findoptions/get_range/#) | يحصل ويضبط النطاق الذي تم البحث فيه.|
| [set_range(ca)](/cells/python-net/ar/aspose.cells/findoptions/set_range/#CellArea) | يحدد النطاق الذي تم البحث عنه.|
