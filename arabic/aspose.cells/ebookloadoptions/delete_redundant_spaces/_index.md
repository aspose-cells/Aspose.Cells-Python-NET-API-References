...
type: docs
weight: 140
url: /ar/aspose.cells/ebookloadoptions/delete_redundant_spaces/
is_root: false
---
##  delete_redundant_spaces عقار

يشير إلى ما إذا كان سيتم حذف المسافات الزائدة عند التفاف النص حول الأسطر باستخدام العلامة `<br>`.
