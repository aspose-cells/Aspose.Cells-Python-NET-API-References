...
| [`aspose.cellsgridjs`](/cells/python-net/ar/aspose.cellsgridjs) | ال**Aspose.Cells.GridJs**تحتوي مساحة الاسم على جميع فئات GridJs التي توفر العمليات الأساسية لإدارة جداول البيانات دون استخدام Microsoft Excel.|
