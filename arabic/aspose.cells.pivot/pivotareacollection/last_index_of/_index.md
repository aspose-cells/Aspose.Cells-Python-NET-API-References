...
type: docs
weight: 60
url: /ar/aspose.cells.pivot/pivotareacollection/last_index_of/
is_root: false
---
...
| معامل| يكتب| وصف|
| :- | :- | :- |
| item | [`PivotArea`](/cells/python-net/ar/aspose.cells.pivot/pivotarea) | الكائن المطلوب تحديد موقعه في قائمة المصفوفة. يمكن أن تكون القيمة فارغة.|
...
* فئة [`PivotAreaCollection`](/cells/python-net/ar/aspose.cells.pivot/pivotareacollection)
