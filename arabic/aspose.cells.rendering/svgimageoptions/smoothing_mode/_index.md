...
type: docs
weight: 340
url: /ar/aspose.cells.rendering/svgimageoptions/smoothing_mode/
is_root: false
---
##  smoothing_mode عقار

يحدد ما إذا كان سيتم تطبيق التنعيم (التنعيم المضاد للتعرج) على الخطوط والمنحنيات وحواف المناطق المملوءة.
