...
type: docs
weight: 360
url: /ar/aspose.cells.drawing/webextensionshape/fill_format/
is_root: false
---
##  fill_format عقار

إرجاع كائن MsoFillFormat الذي يحتوي على خصائص تنسيق التعبئة للشكل المحدد.

###  ملاحظات

 ملاحظة: هذا العضو قديم الآن. بدلاً من،
 من فضلك استخدم خاصية Shape.Fill.
