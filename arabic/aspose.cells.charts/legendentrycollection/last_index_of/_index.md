...
type: docs
weight: 50
url: /ar/aspose.cells.charts/legendentrycollection/last_index_of/
is_root: false
---
...
| معامل| يكتب| وصف|
| :- | :- | :- |
| item | [`LegendEntry`](/cells/python-net/ar/aspose.cells.charts/legendentry) | الكائن المطلوب تحديد موقعه في قائمة المصفوفة. يمكن أن تكون القيمة فارغة.|
...
* فئة [`LegendEntryCollection`](/cells/python-net/ar/aspose.cells.charts/legendentrycollection)
