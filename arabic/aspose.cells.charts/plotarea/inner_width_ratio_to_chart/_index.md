---
title: inner_width_ratio_to_chart عقار
second_title: Aspose.Cells for Python via .NET API المراجع
description:
type: docs
weight: 240
url: /ar/aspose.cells.charts/plotarea/inner_width_ratio_to_chart/
is_root: false
---
##  inner_width_ratio_to_chart عقار

يحصل على أو يعين عرض مساحة الرسم البياني بوحدات نسبة مساحة الرسم البياني.
...
InnerWidth بالبكسل = InnerXRatioToChart * Chart.ChartObject.Width.
###  تعريف:
```python
@property
