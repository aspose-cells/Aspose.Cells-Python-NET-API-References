...
type: docs
weight: 440
url: /ar/aspose.cells.charts/plotarea/y_ratio_to_chart/
is_root: false
---
##  y_ratio_to_chart عقار

يحصل على إحداثيات y للزاوية العلوية العليا لمربع تحديد منطقة الرسم البياني بوحدات نسبة مساحة الرسم البياني.
