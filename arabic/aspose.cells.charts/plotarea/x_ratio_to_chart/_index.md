...
type: docs
weight: 410
url: /ar/aspose.cells.charts/plotarea/x_ratio_to_chart/
is_root: false
---
##  x_ratio_to_chart عقار

يحصل على إحداثيات x للزاوية اليسرى العليا لمربع تحديد منطقة الرسم البياني بوحدات نسبة مساحة الرسم البياني.
