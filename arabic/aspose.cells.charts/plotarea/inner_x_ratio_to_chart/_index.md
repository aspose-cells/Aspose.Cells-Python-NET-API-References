---
title: inner_x_ratio_to_chart عقار
second_title: Aspose.Cells for Python via .NET API المراجع
description:
type: docs
weight: 260
url: /ar/aspose.cells.charts/plotarea/inner_x_ratio_to_chart/
is_root: false
---
##  inner_x_ratio_to_chart عقار

يحصل على إحداثيات x للزاوية العلوية العليا من مساحة الرسم البياني بوحدات نسبة مساحة الرسم البياني.
...
InnerX في البكسل = InnerXRatioToChart * Chart.ChartObject.Width.
###  تعريف:
```python
@property
