...
type: docs
weight: 20
url: /ar/aspose.cells.lowcode/spreadsheetconverter/process/
is_root: false
---
##  process(، ملف القالب، ملف النتيجة){#str-str}
يقوم بتحويل ملف القالب المعطى بين تنسيقات ملفات جدول البيانات.
...
يقوم بالتحويل بين تنسيقات ملفات جداول البيانات المختلفة.
...
* فئة [`SpreadsheetConverter`](/cells/python-net/ar/aspose.cells.lowcode/spreadsheetconverter)
