...
| [font_name](/cells/python-net/zh/aspose.cells.drawing/texteffectformat/font_name) |艺术字中使用的字体名称。|
...
| [rotated_chars](/cells/python-net/zh/aspose.cells.drawing/texteffectformat/rotated_chars) |如果为 true，则指定艺术字中的字符相对于艺术字的边界形状旋转 90 度。|
| [font_size](/cells/python-net/zh/aspose.cells.drawing/texteffectformat/font_size) |艺术字中使用的字体大小（以磅为单位）。|
| [preset_shape](/cells/python-net/zh/aspose.cells.drawing/texteffectformat/preset_shape) |获取和设置预设形状类型。|


### 方法
|方法|描述|
| :- | :- |
| [set_text_effect(effect)](/cells/python-net/zh/aspose.cells.drawing/texteffectformat/set_text_effect/#MsoPresetTextEffect) |设置预设文本效果。|
