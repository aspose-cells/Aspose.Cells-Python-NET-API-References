...
type: docs
weight: 50
url: /zh/aspose.cells.querytables/powerqueryformulaparametercollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [PowerQueryFormulaParameter](/cells/python-net/zh/aspose.cells.querytables/powerqueryformulaparameter) |要在数组列表中定位的对象。该值可以为空。|
