...
type: docs
weight: 60
url: /zh/aspose.cells.querytables/powerqueryformulacollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [`PowerQueryFormula`](/cells/python-net/zh/aspose.cells.querytables/powerqueryformula) |要在数组列表中定位的对象。该值可以为 null。|
