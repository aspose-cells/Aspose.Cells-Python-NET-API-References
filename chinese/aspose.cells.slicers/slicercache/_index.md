...
| [slicer_cache_items](/cells/python-net/zh/aspose.cells.slicers/slicercache/slicer_cache_items) |返回一个 SlicerCacheItem 集合，其中包含切片器缓存中所有项目的集合。只读|
| [name](/cells/python-net/zh/aspose.cells.slicers/slicercache/name) |返回切片器缓存的名称。|
| [source_name](/cells/python-net/zh/aspose.cells.slicers/slicercache/source_name) |返回缓存字段的名称|
