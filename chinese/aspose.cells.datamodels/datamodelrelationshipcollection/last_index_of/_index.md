...
type: docs
weight: 50
url: /zh/aspose.cells.datamodels/datamodelrelationshipcollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [`DataModelRelationship`](/cells/python-net/zh/aspose.cells.datamodels/datamodelrelationship) |要在数组列表中定位的对象。该值可以为 null。|
