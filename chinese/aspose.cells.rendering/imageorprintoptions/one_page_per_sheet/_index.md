...
type: docs
weight: 200
url: /zh/aspose.cells.rendering/imageorprintoptions/one_page_per_sheet/
is_root: false
---
## one_page_per_sheet属性

如果 OnePagePerSheet 为 true ，则一个 sheet 的所有内容将输出到结果中的仅一页。
 pagesetup 的纸张大小将无效，并且 pagesetup 的其他设置
仍将有效。
### 定义：
```python
@property
