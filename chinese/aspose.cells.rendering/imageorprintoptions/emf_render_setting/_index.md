...
type: docs
weight: 110
url: /zh/aspose.cells.rendering/imageorprintoptions/emf_render_setting/
is_root: false
---
...
当设置 [`EmfRenderSetting.EMF_PLUS_PREFER`](/cells/python-net/zh/aspose.cells/emfrendersetting#EMF_PLUS_PREFER) 时，渲染到图像时将解析 EMF+ 条记录，否则仅解析 EMF 条记录。
