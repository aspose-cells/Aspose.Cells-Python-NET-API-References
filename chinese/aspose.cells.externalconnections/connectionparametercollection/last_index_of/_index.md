...
type: docs
weight: 60
url: /zh/aspose.cells.externalconnections/connectionparametercollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [`ConnectionParameter`](/cells/python-net/zh/aspose.cells.externalconnections/connectionparameter) |要在数组列表中定位的对象。该值可以为 null。|
