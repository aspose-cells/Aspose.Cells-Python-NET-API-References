...
| [area](/cells/python-net/zh/aspose.cells.charts/series/area) |表示 Series 对象的背景区域。|
| [border](/cells/python-net/zh/aspose.cells.charts/series/border) |表示 Series 对象的边框。|
| [name](/cells/python-net/zh/aspose.cells.charts/series/name) |获取或设置数据系列的名称。|
| [display_name](/cells/python-net/zh/aspose.cells.charts/series/display_name) |获取显示在图表图形上的系列名称。|
| [count_of_data_values](/cells/python-net/zh/aspose.cells.charts/series/count_of_data_values) |获取数据值的个数。|
...
| [shadow](/cells/python-net/zh/aspose.cells.charts/series/shadow) |如果系列有阴影，则为真。|
| [has_3d_effect](/cells/python-net/zh/aspose.cells.charts/series/has_3d_effect) |如果该系列具有三维外观，则为真。<br/>仅适用于气泡图。|
| [bar_3d_shape_type](/cells/python-net/zh/aspose.cells.charts/series/bar_3d_shape_type) |获取或设置与 3-D 条形图或柱形图一起使用的 3D 形状类型。|
| [bar_shape](/cells/python-net/zh/aspose.cells.charts/series/bar_shape) |获取或设置与 3-D 条形图或柱形图一起使用的 3D 形状类型。|
...
| [x_error_bar](/cells/python-net/zh/aspose.cells.charts/series/x_error_bar) |表示系列的 X 方向误差棒。|
| [y_error_bar](/cells/python-net/zh/aspose.cells.charts/series/y_error_bar) |表示系列的 Y 方向误差条。|
| [has_hi_lo_lines](/cells/python-net/zh/aspose.cells.charts/series/has_hi_lo_lines) |如果折线图有高低线，则为真。<br/>仅适用于折线图。|
| [hi_lo_lines](/cells/python-net/zh/aspose.cells.charts/series/hi_lo_lines) |返回一个 HiLoLines 对象，该对象表示折线图上一系列的高低线。<br/>仅适用于折线图。|
| [has_series_lines](/cells/python-net/zh/aspose.cells.charts/series/has_series_lines) |如果堆积柱形图或条形图具有系列线或<br/>如果 Pie of Pie 图表或 Bar of Pie 图表在两个部分之间有连接线。<br/>仅适用于堆积柱形图、条形图、饼图或条形饼图。|
...
| [has_up_down_bars](/cells/python-net/zh/aspose.cells.charts/series/has_up_down_bars) |如果折线图有上下条，则为真。<br/>仅适用于折线图。|
| [up_bars](/cells/python-net/zh/aspose.cells.charts/series/up_bars) |返回一个 DropBars 对象，表示折线图上的向上条。<br/>仅适用于折线图。|
| [down_bars](/cells/python-net/zh/aspose.cells.charts/series/down_bars) |返回一个 [DropBars](/cells/python-net/zh/aspose.cells.charts/dropbars) 对象，表示折线图上的下降条。<br/>仅适用于折线图。|
| [is_color_varied](/cells/python-net/zh/aspose.cells.charts/series/is_color_varied) |表示点的颜色是否变化。<br/>图表必须仅包含一个系列。|
| [gap_width](/cells/python-net/zh/aspose.cells.charts/series/gap_width) |返回或设置条形或列簇之间的空间，作为条形或列宽的百分比。<br/>此属性的值必须介于 0 和 500 之间。|
...
| [overlap](/cells/python-net/zh/aspose.cells.charts/series/overlap) |指定条和柱的定位方式。<br/>可以是介于 – 100 和 100 之间的值。<br/>仅适用于二维条形图和二维柱形图。|
| [second_plot_size](/cells/python-net/zh/aspose.cells.charts/series/second_plot_size) |返回或设置饼图饼图或饼图条形图的次要部分的大小，<br/>作为主要馅饼大小的百分比。<br/>可以是 5 到 200 之间的值。|
| [split_type](/cells/python-net/zh/aspose.cells.charts/series/split_type) |返回或设置一个值，该值指示如何确定哪些数据点位于第二个饼图或饼图中的饼图或饼图中的条形图<br/>饼形图。|
| [split_value](/cells/python-net/zh/aspose.cells.charts/series/split_value) |返回或设置一个值，该值将用于确定哪些数据点在第二个饼图或条形图中<br/>饼饼图或条形饼图。|
| [is_auto_split](/cells/python-net/zh/aspose.cells.charts/series/is_auto_split) |指示阈值是否是自动的。|
| [bubble_scale](/cells/python-net/zh/aspose.cells.charts/series/bubble_scale) |获取或设置指定图表组中气泡的比例因子。<br/>它可以是从 0（零）到 300 的整数值，<br/>对应于默认大小的百分比。<br/>仅适用于气泡图。|
| [size_represents](/cells/python-net/zh/aspose.cells.charts/series/size_represents) |获取或设置气泡大小在气泡图上表示的值。|
| [show_negative_bubbles](/cells/python-net/zh/aspose.cells.charts/series/show_negative_bubbles) |如果图表组显示负气泡，则为真。仅对气泡图有效。|
...
| [explosion](/cells/python-net/zh/aspose.cells.charts/series/explosion) |开放饼图切片与饼图中心的距离表示为饼图直径的百分比。|
| [has_radar_axis_labels](/cells/python-net/zh/aspose.cells.charts/series/has_radar_axis_labels) |如果雷达图具有类别轴标签，则为真。仅适用于雷达图。|
...
| [shape_properties](/cells/python-net/zh/aspose.cells.charts/series/shape_properties) |获取包含 Series 的视觉形状属性的 [ShapePropertyCollection](/cells/python-net/zh/aspose.cells.drawing/shapepropertycollection) 对象。|


### 方法
|方法|描述|
| :- | :- |
| [move(count)](/cells/python-net/zh/aspose.cells.charts/series/move/#int) |向上或向下移动系列。|
