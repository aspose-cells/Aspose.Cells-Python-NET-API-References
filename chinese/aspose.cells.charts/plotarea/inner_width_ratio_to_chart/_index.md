---
title: inner_width_ratio_to_chart属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 240
url: /zh/aspose.cells.charts/plotarea/inner_width_ratio_to_chart/
is_root: false
---
## inner_width_ratio_to_chart属性

获取或设置绘图区域的宽度，以图表区域的比例为单位。
...
像素内宽度 = InnerXRatioToChart * Chart.ChartObject.Width。
### 定义：
```python
@property
