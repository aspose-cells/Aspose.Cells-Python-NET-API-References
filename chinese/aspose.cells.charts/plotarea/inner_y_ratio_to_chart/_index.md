---
title: inner_y_ratio_to_chart属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 280
url: /zh/aspose.cells.charts/plotarea/inner_y_ratio_to_chart/
is_root: false
---
## inner_y_ratio_to_chart属性
...
像素中的 InnerY = InnerYRatioToChart * chart.ChartObject.Width。
### 定义：
```python
@property
