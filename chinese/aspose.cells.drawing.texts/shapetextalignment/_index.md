...
|属性|描述|
| :- | :- |
| [is_text_wrapped](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/is_text_wrapped) |获取和设置包含文本的形状的文本环绕类型。|
| [rotate_text_with_shape](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/rotate_text_with_shape) |指示是否旋转带有形状的文本。|
...
| [rotation_angle](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/rotation_angle) |获取和设置形状的旋转。|
| [text_vertical_type](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/text_vertical_type) |获取和设置文本方向。|
...
| [top_margin_pt](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/top_margin_pt) |以点为单位返回顶部边距|
| [bottom_margin_pt](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/bottom_margin_pt) |以点为单位返回底部边距|
...
| [number_of_columns](/cells/python-net/zh/aspose.cells.drawing.texts/shapetextalignment/number_of_columns) |获取和设置边框中文本的列数。|
