...
type: docs
weight: 70
url: /zh/aspose.cells.markup/smarttagpropertycollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [`SmartTagProperty`](/cells/python-net/zh/aspose.cells.markup/smarttagproperty) |要在数组列表中定位的对象。该值可以为 null。|
