...
|属性|描述|
| :- | :- |
| [axis_color](/cells/python-net/zh/aspose.cells/databar/axis_color) |获取具有条件格式的单元格的轴颜色作为数据条。|
| [axis_position](/cells/python-net/zh/aspose.cells/databar/axis_position) |获取或设置由条件格式规则指定的数据条轴的位置。|
...
| [bar_border](/cells/python-net/zh/aspose.cells/databar/bar_border) |获取一个对象，该对象指定数据栏的边框。|
...
| [show_value](/cells/python-net/zh/aspose.cells/databar/show_value) |获取或设置标志，指示是否显示应用此数据栏的单元格的值。<br/>默认值为真。|


### 方法
|方法|描述|
| :- | :- |
| [to_image(cell, img_opts)](/cells/python-net/zh/aspose.cells/databar/to_image/#Cell-aspose.cells.rendering.ImageOrPrintOptions) |将单元格中的数据条渲染为图像字节数组。|
