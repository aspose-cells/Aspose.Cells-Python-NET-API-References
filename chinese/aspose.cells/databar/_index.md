...
|属性|描述|
| :- | :- |
| [axis_color](/cells/python-net/zh/aspose.cells/databar/axis_color) |获取具有条件格式的数据条单元格的轴的颜色。|
| [axis_position](/cells/python-net/zh/aspose.cells/databar/axis_position) |获取或设置条件格式规则指定的数据条的轴的位置。|
| [bar_fill_type](/cells/python-net/zh/aspose.cells/databar/bar_fill_type) |获取或设置数据条如何填充颜色。|
| [direction](/cells/python-net/zh/aspose.cells/databar/direction) |获取或设置数据栏的显示方向。|
| [bar_border](/cells/python-net/zh/aspose.cells/databar/bar_border) |获取指定数据条边框的对象。|
| [negative_bar_format](/cells/python-net/zh/aspose.cells/databar/negative_bar_format) |获取与数据栏条件格式规则关联的 NegativeBarFormat 对象。|
...
| [color](/cells/python-net/zh/aspose.cells/databar/color) |获取或设置此 DataBar 的颜色。|
...
| [show_value](/cells/python-net/zh/aspose.cells/databar/show_value) |获取或设置指示是否显示应用此数据条的单元格的值的标志。<br/>默认值为 true。|


### 方法
|方法|描述|
| :- | :- |
| [`to_image(self, cell, img_opts)`](/cells/python-net/zh/aspose.cells/databar/to_image/#aspose.cells.cell-aspose.cells.rendering.imageorprintoptions) |将单元格中的数据条渲染为图像字节数组。|
