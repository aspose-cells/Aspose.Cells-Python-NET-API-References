...
type: docs
weight: 70
url: /zh/aspose.cells/threadedcommentauthorcollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [`ThreadedCommentAuthor`](/cells/python-net/zh/aspose.cells/threadedcommentauthor) |要在数组列表中定位的对象。该值可以为 null。|
