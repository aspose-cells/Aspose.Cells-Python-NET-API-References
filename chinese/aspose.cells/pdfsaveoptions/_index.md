...
|构造器|描述|
| :- | :- |
| [PdfSaveOptions()](/cells/python-net/zh/aspose.cells/pdfsaveoptions/__init__/#) |创建用于保存 pdf 文件的选项。|
...
| [validate_merged_areas](/cells/python-net/zh/aspose.cells/pdfsaveoptions/validate_merged_areas) |指示是否在保存文件之前验证合并的单元格。|
| [merge_areas](/cells/python-net/zh/aspose.cells/pdfsaveoptions/merge_areas) |指示是否在保存文件之前合并条件格式和验证区域。|
| [create_directory](/cells/python-net/zh/aspose.cells/pdfsaveoptions/create_directory) |如果为 true 并且目录不存在，则在保存文件之前会自动创建目录。|
| [sort_names](/cells/python-net/zh/aspose.cells/pdfsaveoptions/sort_names) |指示是否在保存文件之前对定义的名称进行排序。|
| [sort_external_names](/cells/python-net/zh/aspose.cells/pdfsaveoptions/sort_external_names) |指示是否在保存文件之前对外部定义的名称进行排序。|
| [refresh_chart_cache](/cells/python-net/zh/aspose.cells/pdfsaveoptions/refresh_chart_cache) |指示是否刷新图表缓存数据|
...
| [is_font_substitution_char_granularity](/cells/python-net/zh/aspose.cells/pdfsaveoptions/is_font_substitution_char_granularity) |指示当单元格字体不兼容时是否仅替换字符的字体。|
| [one_page_per_sheet](/cells/python-net/zh/aspose.cells/pdfsaveoptions/one_page_per_sheet) |如果 OnePagePerSheet 为 true ，结果中一张纸的所有内容将只输出一页。<br/> pagesetup的纸张大小会失效，pagesetup的其他设置<br/>仍然会生效。|
| [all_columns_in_one_page_per_sheet](/cells/python-net/zh/aspose.cells/pdfsaveoptions/all_columns_in_one_page_per_sheet) |如果 AllColumnsInOnePagePerSheet 为 true ，则一张工作表的所有列内容将仅输出到一页结果。<br/> pagesetup 的纸张大小的宽度将被忽略，pagesetup 的其他设置<br/>仍然会生效。|
| [ignore_error](/cells/python-net/zh/aspose.cells/pdfsaveoptions/ignore_error) |指示是否需要在渲染时隐藏错误。<br/>错误可能是形状、图像、图表渲染等方面的错误。|
| [output_blank_page_when_nothing_to_print](/cells/python-net/zh/aspose.cells/pdfsaveoptions/output_blank_page_when_nothing_to_print) |指示当没有可打印的内容时是否输出空白页。|
| [page_index](/cells/python-net/zh/aspose.cells/pdfsaveoptions/page_index) |获取或设置要保存的第一个页面的从 0 开始的索引。|
...
| [sheet_set](/cells/python-net/zh/aspose.cells/pdfsaveoptions/sheet_set) |获取或设置要呈现的工作表。默认为工作簿中的所有可见工作表：[SheetSet.visible](/cells/python-net/zh/aspose.cells.rendering/sheetset#visible)。|
| [draw_object_event_handler](/cells/python-net/zh/aspose.cells/pdfsaveoptions/draw_object_event_handler) |实现该接口，在渲染时获取DrawObject和Bound。|
| [page_saving_callback](/cells/python-net/zh/aspose.cells/pdfsaveoptions/page_saving_callback) |控制/指示页面保存过程的进度。|
| [embed_standard_windows_fonts](/cells/python-net/zh/aspose.cells/pdfsaveoptions/embed_standard_windows_fonts) | True 以嵌入 True Type 字体。<br/>仅影响 ASCII 字符 32-127。<br/>字符代码大于 127 的字体总是被嵌入。<br/>始终嵌入 PDF/A-1a、PDF/A-1b 标准的字体。<br/>默认为真。|
...
| [compliance](/cells/python-net/zh/aspose.cells/pdfsaveoptions/compliance) |工作簿将根据此属性中的 PdfCompliance 转换为 pdf。|
| [security_options](/cells/python-net/zh/aspose.cells/pdfsaveoptions/security_options) |在 xls2pdf 结果中需要安全性时设置此选项。|
...
| [producer](/cells/python-net/zh/aspose.cells/pdfsaveoptions/producer) |获取和设置生成的 pdf 文档的制作者。|
| [optimization_type](/cells/python-net/zh/aspose.cells/pdfsaveoptions/optimization_type) |获取和设置 pdf 优化类型。|
| [custom_properties_export](/cells/python-net/zh/aspose.cells/pdfsaveoptions/custom_properties_export) |获取或设置一个值，该值确定将 [CustomDocumentPropertyCollection](/cells/python-net/zh/aspose.cells.properties/customdocumentpropertycollection) 导出到 PDF 文件的方式。默认值为无。|
| [export_document_structure](/cells/python-net/zh/aspose.cells/pdfsaveoptions/export_document_structure) |指示是否导出文档结构。|
| [emf_render_setting](/cells/python-net/zh/aspose.cells/pdfsaveoptions/emf_render_setting) |渲染 Emf 图元文件的设置。|
...
|方法|描述|
| :- | :- |
| [set_image_resample(desired_ppi, jpeg_quality)](/cells/python-net/zh/aspose.cells/pdfsaveoptions/set_image_resample/#int-int) |设置重采样图像和 jpeg 质量所需的 PPI（每英寸像素）。<br/>所有图像都将转换为具有指定质量设置的 JPEG，<br/>并且大于指定 PPI（每英寸像素数）的图像将被重新采样。|
