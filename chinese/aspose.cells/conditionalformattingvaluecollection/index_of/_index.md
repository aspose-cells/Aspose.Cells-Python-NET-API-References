...
type: docs
weight: 50
url: /zh/aspose.cells/conditionalformattingvaluecollection/index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [ConditionalFormattingValue](/cells/python-net/zh/aspose.cells/conditionalformattingvalue) |要在数组列表中定位的对象。该值可以为空。|
