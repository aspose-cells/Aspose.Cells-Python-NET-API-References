...
| bidirectional | bool |是否自动将本地函数名映射到标准函数名。<br/>如果为真，本地名称将自动映射到标准名称<br/>因此用户无需再次拨打 [`SettableGlobalizationSettings.set_standard_function_name`](/cells/python-net/zh/aspose.cells/settableglobalizationsettings/set_standard_function_name)<br/>对于相同的标准和本地名称对|
