...
|范围|类型|描述|
| :- | :- | :- |
| standard_name | str |内置名称的标准（en-US 语言环境）名称文本。|
| local_name | str |与语言环境相关的名称文本|
| bidirectional | bool |是否自动将本地名称文本映射到标准名称文本。<br/>如果为真，本地名称文本将自动映射到标准名称文本<br/>因此用户无需再次拨打 [`SettableGlobalizationSettings.set_standard_built_in_name`](/cells/python-net/zh/aspose.cells/settableglobalizationsettings/set_standard_built_in_name)<br/>对于相同的标准和本地名称对|
