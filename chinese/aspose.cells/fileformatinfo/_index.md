...
FileFormatInfo 类型公开以下成员：

### 构造函数
|构造函数|描述|
| :- | :- |
| [__init__](/cells/python-net/zh/aspose.cells/fileformatinfo/__init__/#) |构造 FileFormatInfo 的新实例|
...
| [is_encrypted](/cells/python-net/zh/aspose.cells/fileformatinfo/is_encrypted) |如果文档已加密并且需要密码才能打开，则返回 true。|
