...
| [has_custom_style](/cells/python-net/zh/aspose.cells/column/has_custom_style) |指示此列是否具有自定义样式设置（不同于从工作簿继承的默认样式设置）。|
...
|方法|描述|
| :- | :- |
| [apply_style(style, flag)](/cells/python-net/zh/aspose.cells/column/apply_style/#Style-StyleFlag) |为整列应用格式。|
| [get_style()](/cells/python-net/zh/aspose.cells/column/get_style/#) |获取此列的样式。|
| [set_style(style)](/cells/python-net/zh/aspose.cells/column/set_style/#Style) |设置此列的样式。|
