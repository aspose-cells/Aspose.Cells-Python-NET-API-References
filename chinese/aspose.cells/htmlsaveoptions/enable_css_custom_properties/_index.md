---
title: enable_css_custom_properties属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 180
url: /zh/aspose.cells/htmlsaveoptions/enable_css_custom_properties/
is_root: false
---
## enable_css_custom_properties属性

使用 CSS 自定义属性优化 html 的输出。例如，对于同一幅 base64 图片出现多次的情况，使用自定义属性可以使图片数据仅保存一次，从而提升最终 html 的性能。
默认值为 false。
### 定义：
```python
@property
