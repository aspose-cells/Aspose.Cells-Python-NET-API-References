---
title: convert_formulas_data属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 110
url: /zh/aspose.cells/htmlloadoptions/convert_formulas_data/
is_root: false
---
## convert_formulas_data属性

如果为真，则当字符串值以字符“=”开头时，将字符串转换为公式，默认值为假。

### 注意事项

注意：此属性现已过时。
相反，请使用 HtmlLoadOptions.HasFormula 属性。
