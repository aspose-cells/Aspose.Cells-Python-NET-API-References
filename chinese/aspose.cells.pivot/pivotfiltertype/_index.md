...
| CAPTION_NOT_BEGINS_WITH |指示字段标题的“不开头”过滤器。|
| CAPTION_NOT_BETWEEN |指示字段标题的“不在之间”过滤器。|
| CAPTION_NOT_CONTAINS |指示字段标题的“不包含”过滤器。|
| CAPTION_NOT_ENDS_WITH |指示字段标题的“不结尾”过滤器。|
| CAPTION_NOT_EQUAL |指示字段标题的“不等于”过滤器。|
| COUNT |表示“计数”过滤器。|
| DATE_BETWEEN |指示日期值的“介于”过滤器。|
| DATE_EQUAL |指示日期值的“等于”过滤器。|
| DATE_NEWER_THAN |指示日期值的“更新于”过滤器。|
| DATE_NEWER_THAN_OR_EQUAL |指示日期值的“更新于或等于”过滤器。|
| DATE_NOT_BETWEEN |指示日期值的“不在之间”过滤器。|
...
| UNKNOWN |指示应用程序未知数据透视表筛选器。|
| VALUE_BETWEEN |指示文本和数值的“值介于”过滤器。|
| VALUE_EQUAL |指示文本和数值的“值相等”过滤器。|
...
| VALUE_NOT_BETWEEN |指示文本和数值的“值不在之间”过滤器。|
