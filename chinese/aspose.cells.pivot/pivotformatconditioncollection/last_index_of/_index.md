...
type: docs
weight: 70
url: /zh/aspose.cells.pivot/pivotformatconditioncollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [`PivotFormatCondition`](/cells/python-net/zh/aspose.cells.pivot/pivotformatcondition) |要在数组列表中定位的对象。该值可以为 null。|
