...
Ajouter une nouvelle chronologie en utilisant un tableau croisé dynamique comme source de données
...
| :- | :- | :- |
| pivot | aspose.cells.pivot.PivotTable | Objet PivotTable|
| row | int |Index de ligne de la cellule dans le coin supérieur gauche de la plage de chronologie.|
| column | int | Index de colonne de la cellule dans le coin supérieur gauche de la plage de chronologie.|
| base_field_name | str | Le nom de PivotField dans PivotTable.BaseFields|
