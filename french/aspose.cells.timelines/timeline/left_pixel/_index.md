...
type: docs
weight: 50
url: /fr/aspose.cells.timelines/timeline/left_pixel/
is_root: false
---
##  left_pixel propriété

Renvoie ou définit le décalage horizontal de la forme de la chronologie à partir de sa colonne de gauche, en pixels.

###  Remarques

 REMARQUE : Ce membre est désormais obsolète. À la place,
 veuillez utiliser la propriété Shape.Left.
