...
Lorsque [`EmfRenderSetting.EMF_PLUS_PREFER`](/cells/python-net/fr/aspose.cells/emfrendersetting#EMF_PLUS_PREFER) est défini, alors les enregistrements EMF+ seront analysés lors du rendu en image, sinon seuls les enregistrements EMF seront analysés.
