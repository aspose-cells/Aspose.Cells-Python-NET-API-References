---
title: méthode add_ole_object_with_linked_image
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 210
url: /fr/aspose.cells.drawing/shapecollection/add_ole_object_with_linked_image/
is_root: false
---
...
| height | int | Hauteur de la forme. En pixels.|
| width | int | Largeur de la forme. En pixels.|
