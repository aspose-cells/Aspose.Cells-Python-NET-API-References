---
title: inner_height_ratio_to_chart propriété
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 220
url: /fr/aspose.cells.charts/plotarea/inner_height_ratio_to_chart/
is_root: false
---
##  inner_height_ratio_to_chart propriété

Obtient ou définit la hauteur de la zone de tracé en unités de rapport de la zone du graphique.
...
InnerHeight en Pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Définition:
```python
@property
