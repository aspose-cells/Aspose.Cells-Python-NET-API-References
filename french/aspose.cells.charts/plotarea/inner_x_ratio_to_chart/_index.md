---
title: inner_x_ratio_to_chart propriété
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 260
url: /fr/aspose.cells.charts/plotarea/inner_x_ratio_to_chart/
is_root: false
---
##  inner_x_ratio_to_chart propriété
...
InnerX en Pixel = InnerXRatioToChart * chart.ChartObject.Width.
###  Définition:
```python
@property
