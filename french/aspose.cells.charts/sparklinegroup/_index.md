...
Un groupe de lignes sparkline spécifie le type, les paramètres d'affichage et les paramètres d'axe des lignes sparkline.
...
| [type](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/type) | Indique le type de sparkline du groupe de sparklines.|
...
| [display_hidden](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/display_hidden) | Indique s’il faut afficher les données dans les lignes et colonnes masquées.|
...
| [high_point_color](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/high_point_color) | Obtient et définit la couleur des points de données les plus élevés du groupe sparkline.|
| [show_low_point](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/show_low_point) | Indique s’il faut mettre en évidence les points de données les plus bas dans le groupe sparkline.|
| [low_point_color](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/low_point_color) | Obtient et définit la couleur des points de données les plus bas du groupe sparkline.|
| [show_negative_points](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/show_negative_points) | Indique s’il faut mettre en évidence les valeurs négatives sur le groupe sparkline avec une couleur ou un marqueur différent.|
...
| [first_point_color](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/first_point_color) | Obtient et définit la couleur du premier point de données du groupe sparkline.|
...
| [last_point_color](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/last_point_color) | Obtient et définit la couleur du dernier point de données du groupe sparkline.|
...
| [series_color](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/series_color) | Obtient et définit la couleur des sparklines dans le groupe de sparklines.|
...
| [line_weight](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/line_weight) | Obtient et définit l’épaisseur de ligne dans chaque ligne sparkline du groupe sparkline, en unités de points.|
...
| Méthode| Description|
| :- | :- |
| [reset_ranges](/cells/python-net/fr/aspose.cells.charts/sparklinegroup/reset_ranges/#str-bool-aspose.cells.CellArea) | Réinitialise la plage de données et la plage d’emplacements du groupe sparkline.<br/> Cette méthode effacera les éléments sparkline d'origine du groupe et créera de nouveaux éléments sparkline pour les nouvelles plages.|
