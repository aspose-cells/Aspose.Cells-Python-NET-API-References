...
type: docs
weight: 560
url: /fr/aspose.cells.saving/ebooksaveoptions/merge_empty_td_forcely/
is_root: false
---
##  merge_empty_td_forcely propriété

 Indique si la fusion des éléments TD vides est forcée lors de l'exportation du fichier au format HTML.
 La taille du fichier HTML sera considérablement réduite après avoir défini la valeur sur true. La valeur par défaut est fausse.
