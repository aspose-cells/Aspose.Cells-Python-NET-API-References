...
type: docs
weight: 440
url: /fr/aspose.cells.saving/ebooksaveoptions/export_worksheet_css_separately/
is_root: false
---
##  export_worksheet_css_separately propriété

Indique si vous souhaitez exporter le CSS de la feuille de calcul séparément. La valeur par défaut est false.
###  Définition:
```python
@property
