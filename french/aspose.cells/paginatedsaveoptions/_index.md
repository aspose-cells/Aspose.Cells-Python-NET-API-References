...
| [clear_data](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/clear_data) | Videz le classeur après avoir enregistré le fichier.|
...
| [validate_merged_areas](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/validate_merged_areas) | Indique s'il faut valider les cellules fusionnées avant d'enregistrer le fichier.|
| [merge_areas](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/merge_areas) | Indique s'il faut fusionner les zones de mise en forme conditionnelle et de validation avant d'enregistrer le fichier.|
| [create_directory](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/create_directory) | Si true et que le répertoire n'existe pas, le répertoire sera automatiquement créé avant d'enregistrer le fichier.|
| [sort_names](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/sort_names) | Indique s'il faut trier les noms définis avant d'enregistrer le fichier.|
| [sort_external_names](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/sort_external_names) |Indique s'il faut trier les noms définis externes avant d'enregistrer le fichier.|
| [refresh_chart_cache](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/refresh_chart_cache) | Indique si l'actualisation des données du cache du graphique|
...
| [update_smart_art](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/update_smart_art) | Indique si la mise à jour du paramètre d'art intelligent.<br/> La valeur par défaut est faux.|
...
| [is_font_substitution_char_granularity](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/is_font_substitution_char_granularity) | Indique s'il faut uniquement remplacer la police de caractère lorsque la police de cellule n'est pas compatible avec celle-ci.|
| [one_page_per_sheet](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/one_page_per_sheet) | Si OnePagePerSheet est true , tout le contenu d'une feuille sortira sur une seule page dans le résultat.<br/> Le format de papier de pagesetup sera invalide, et les autres paramètres de pagesetup<br/> prendra toujours effet.|
| [all_columns_in_one_page_per_sheet](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/all_columns_in_one_page_per_sheet) | Si AllColumnsInOnePagePerSheet est true , tout le contenu de la colonne d'une feuille sortira sur une seule page dans le résultat.<br/> La largeur de la taille du papier de pagesetup sera ignorée, et les autres paramètres de pagesetup<br/> prendra toujours effet.|
...
| [sheet_set](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/sheet_set) |Obtient ou définit les feuilles à rendre. La valeur par défaut est toutes les feuilles visibles dans le classeur : [SheetSet.visible](/cells/python-net/fr/aspose.cells.rendering/sheetset#visible).|
...
| [page_saving_callback](/cells/python-net/fr/aspose.cells/paginatedsaveoptions/page_saving_callback) | Contrôler/indiquer la progression du processus d'enregistrement de la page.|
