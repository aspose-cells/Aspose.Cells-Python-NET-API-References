...
| :- | :- |
| [__init__](/cells/python-net/fr/aspose.cells/pptxsaveoptions/__init__/#) | Représente les options de sauvegarde pptx.|
| [__init__](/cells/python-net/fr/aspose.cells/pptxsaveoptions/__init__/#bool) | Représente les options d'enregistrement du fichier .pptx.|
...
| [clear_data](/cells/python-net/fr/aspose.cells/pptxsaveoptions/clear_data) | Rendez le classeur vide après avoir enregistré le fichier.|
...
| [validate_merged_areas](/cells/python-net/fr/aspose.cells/pptxsaveoptions/validate_merged_areas) | Indique si vous validez les cellules fusionnées avant d'enregistrer le fichier.|
| [merge_areas](/cells/python-net/fr/aspose.cells/pptxsaveoptions/merge_areas) | Indique si fusionner les zones de mise en forme conditionnelle et de validation avant d'enregistrer le fichier.|
| [create_directory](/cells/python-net/fr/aspose.cells/pptxsaveoptions/create_directory) | Si vrai et que le répertoire n'existe pas, le répertoire sera automatiquement créé avant d'enregistrer le fichier.|
| [sort_names](/cells/python-net/fr/aspose.cells/pptxsaveoptions/sort_names) | Indique si le tri des noms définis avant d'enregistrer le fichier.|
| [sort_external_names](/cells/python-net/fr/aspose.cells/pptxsaveoptions/sort_external_names) | Indique si le tri des noms définis externes avant d'enregistrer le fichier.|
| [refresh_chart_cache](/cells/python-net/fr/aspose.cells/pptxsaveoptions/refresh_chart_cache) | Indique si l'actualisation des données du cache de graphique|
...
| [update_smart_art](/cells/python-net/fr/aspose.cells/pptxsaveoptions/update_smart_art) | Indique si la mise à jour des paramètres d'art intelligent est effectuée.<br/> La valeur par défaut est fausse.|
...
| [is_font_substitution_char_granularity](/cells/python-net/fr/aspose.cells/pptxsaveoptions/is_font_substitution_char_granularity) |Indique s'il convient de remplacer la police de caractère uniquement lorsque la police de la cellule n'est pas compatible avec celui-ci.|
| [one_page_per_sheet](/cells/python-net/fr/aspose.cells/pptxsaveoptions/one_page_per_sheet) | Si OnePagePerSheet est true , tout le contenu d’une feuille sera affiché sur une seule page.<br/> Le format de papier de la configuration de la page sera invalide et les autres paramètres de la configuration de la page<br/> prendra toujours effet.|
| [all_columns_in_one_page_per_sheet](/cells/python-net/fr/aspose.cells/pptxsaveoptions/all_columns_in_one_page_per_sheet) | Si AllColumnsInOnePagePerSheet est true , tout le contenu des colonnes d’une feuille sera affiché sur une seule page dans le résultat.<br/> La largeur du format de papier de pagesetup sera ignorée et les autres paramètres de pagesetup<br/> prendra toujours effet.|
...
| [sheet_set](/cells/python-net/fr/aspose.cells/pptxsaveoptions/sheet_set) |Obtient ou définit les feuilles à restituer. La valeur par défaut correspond à toutes les feuilles visibles dans le classeur : [`SheetSet.visible`](/cells/python-net/fr/aspose.cells.rendering/sheetset#visible).|
...
| [page_saving_callback](/cells/python-net/fr/aspose.cells/pptxsaveoptions/page_saving_callback) | Contrôler/indiquer la progression du processus d’enregistrement des pages.|
| [emf_render_setting](/cells/python-net/fr/aspose.cells/pptxsaveoptions/emf_render_setting) | Paramètre de rendu du métafichier Emf.|
| [ignore_hidden_rows](/cells/python-net/fr/aspose.cells/pptxsaveoptions/ignore_hidden_rows) | Indique si les lignes masquées sont ignorées lors de la conversion d'Excel en PowerPoint.|
| [adjust_font_size_for_row_type](/cells/python-net/fr/aspose.cells/pptxsaveoptions/adjust_font_size_for_row_type) | Représente le type de ligne dont la taille de la police doit être ajustée si la hauteur de la ligne est petite.|
| [export_view_type](/cells/python-net/fr/aspose.cells/pptxsaveoptions/export_view_type) | Obtient et définit le type d'affichage lors de l'exportation vers PowerPoint.<br/> Le type d'exportation par défaut fonctionne comme une impression.|
