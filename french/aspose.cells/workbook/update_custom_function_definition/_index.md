...
Cette méthode peut être utilisée pour certains scénarios particuliers. Par exemple, si l'utilisateur a besoin de certains paramètres
de certaines fonctions personnalisées soient calculées en mode tableau, l'utilisateur peut alors fournir sa propre définition avec implémentation
...
Une fois les données des formules mises à jour, ces paramètres spécifiés seront automatiquement calculés en mode tableau.
