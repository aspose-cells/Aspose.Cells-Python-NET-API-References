...
type: docs
weight: 470
url: /fr/aspose.cells/workbook/content_type_properties/
is_root: false
---
##  content_type_properties propriété

Obtient la liste des objets [ContentTypeProperty](/cells/python-net/fr/aspose.cells.properties/contenttypeproperty) dans le classeur.
###  Définition:
```python
@property
