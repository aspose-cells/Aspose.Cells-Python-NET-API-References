...
Obtient les indices des paramètres de la fonction personnalisée donnée qui doivent être calculés en mode tableau.


###  Retour

Indices des paramètres qui doivent être calculés en mode tableau pour une fonction personnalisée donnée.
La valeur par défaut est null, il n'y a aucun paramètre qui doit être calculé en mode tableau pour la fonction personnalisée.
