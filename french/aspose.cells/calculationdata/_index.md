...
| Méthode| Description|
| :- | :- |
| [`get_param_value(self, index)`](/cells/python-net/fr/aspose.cells/calculationdata/get_param_value/#int) |Obtient l'objet valeur représenté du paramètre à un index donné.|
| [`get_param_value_in_array_mode(self, index, max_row_count, max_column_count)`](/cells/python-net/fr/aspose.cells/calculationdata/get_param_value_in_array_mode/#int-int-int) | Obtient la ou les valeurs du paramètre à l'index donné.<br/>Si le paramètre est une sorte d’expression qui doit être calculée,<br/> alors il sera calculé en mode tableau.|
| [`get_param_text(self, index)`](/cells/python-net/fr/aspose.cells/calculationdata/get_param_text/#int) | Obtient le texte littéral du paramètre à l'index donné.|
