...
Obtient la ou les valeurs du paramètre à un index donné.
...
Et pour ce genre de situation, il est préférable de préciser la limite du nombre de lignes/colonnes
