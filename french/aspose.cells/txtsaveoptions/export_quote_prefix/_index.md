...
type: docs
weight: 100
url: /fr/aspose.cells/txtsaveoptions/export_quote_prefix/
is_root: false
---
##  export_quote_prefix propriété

Indique si le guillemet simple doit être exporté dans le cadre de la valeur d'une cellule
quand [Style.quote_prefix](/cells/python-net/fr/aspose.cells/style#quote_prefix) est vrai pour cela. La valeur par défaut est false.
###  Définition:
```python
@property
