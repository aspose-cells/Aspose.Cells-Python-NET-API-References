...
| to_r1c1 | bool | Dans quel style de référence convertir la formule.<br/>Si la formule originale est de style de référence A1,<br/>alors cette valeur doit être vraie pour que la formule soit convertie du style de référence A1 en R1C1 ;<br/>Si la formule originale est de style référence R1C1,<br/> alors cette valeur doit être fausse afin que la formule soit convertie du style de référence R1C1 en style de référence A1 ;|
