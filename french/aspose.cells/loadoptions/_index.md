...
| :- | :- |
| [__init__](/cells/python-net/fr/aspose.cells/loadoptions/__init__/#) | Crée une option de chargement du fichier.|
| [__init__](/cells/python-net/fr/aspose.cells/loadoptions/__init__/#aspose.cells.LoadFormat) | Crée une option de chargement du fichier.|
...
| [parsing_pivot_cached_records](/cells/python-net/fr/aspose.cells/loadoptions/parsing_pivot_cached_records) | Indique si l’analyse des enregistrements mis en cache par pivot lors du chargement du fichier.<br/> La valeur par défaut est fausse.|
| [language_code](/cells/python-net/fr/aspose.cells/loadoptions/language_code) | Obtient ou définit la langue de l'interface utilisateur de la version du Workbook en fonction du CountryCode qui a enregistré le fichier.|
...
| [auto_filter](/cells/python-net/fr/aspose.cells/loadoptions/auto_filter) | Indique si le filtrage automatique des données lors du chargement des fichiers est effectué.|
...
| [preserve_padding_spaces_in_formula](/cells/python-net/fr/aspose.cells/loadoptions/preserve_padding_spaces_in_formula) | Indique si les espaces et les sauts de ligne qui sont remplis entre les jetons de formule sont conservés<br/>tout en obtenant et en définissant des formules.<br/> La valeur par défaut est fausse.|


###  Méthodes
| Méthode| Description|
| :- | :- |
| [set_paper_size](/cells/python-net/fr/aspose.cells/loadoptions/set_paper_size/#aspose.cells.PaperSizeType) | Définit le format de papier d'impression par défaut à partir des paramètres par défaut de l'imprimante.|
