...
Vous devez appeler la méthode [`Column.apply_style`](/cells/python-net/fr/aspose.cells/column/apply_style) ou [`Column.set_style`](/cells/python-net/fr/aspose.cells/column/set_style)
