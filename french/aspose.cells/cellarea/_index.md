...
| :- | :- |
| [`__init__(self)`](/cells/python-net/fr/aspose.cells/cellarea/__init__/#) | Construit une nouvelle instance de CellArea|


###  Propriétés
| Propriété| Description|
| :- | :- |
| [start_row](/cells/python-net/fr/aspose.cells/cellarea/start_row) | Obtient ou définit la ligne de départ de cette zone.|
| [end_row](/cells/python-net/fr/aspose.cells/cellarea/end_row) | Obtient ou définit la ligne de fin de cette zone.|
| [start_column](/cells/python-net/fr/aspose.cells/cellarea/start_column) | Obtient ou définit la colonne de départ de cette zone.|
...
| [`compare_to(self, obj)`](/cells/python-net/fr/aspose.cells/cellarea/compare_to/#any) | Comparez deux objets CellArea en fonction de leur coin supérieur gauche.|
