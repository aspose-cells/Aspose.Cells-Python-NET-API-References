---
title: watermark propriété
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 510
url: /fr/aspose.cells/pdfsaveoptions/watermark/
is_root: false
---
##  watermark propriété

Obtient ou définit watermark à sortir.

###  Exemple

Le code suivant définit watermark dans le PDF de sortie.
...
* classe [`RenderingWatermark`](/cells/python-net/fr/aspose.cells.rendering/renderingwatermark)
