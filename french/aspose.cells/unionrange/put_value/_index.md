...
type: docs
weight: 60
url: /fr/aspose.cells/unionrange/put_value/
is_root: false
---
##  put_value(self, string_value, is_converted, set_style) {#str-bool-bool}
Place une valeur dans la plage, si nécessaire, la valeur sera convertie en un autre type de données et le format numérique de la cellule sera réinitialisé.
