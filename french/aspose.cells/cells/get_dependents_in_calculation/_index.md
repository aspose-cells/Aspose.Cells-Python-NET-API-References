...
| recursive | bool | Si renvoie les dépendants qui ne font pas directement référence à la cellule spécifique<br/> mais référence à d'autres feuilles de cette cellule.|
###  Remarques
...
Pour plus de détails et d'exemples, veuillez consulter le [`Cell.get_dependents_in_calculation`](/cells/python-net/fr/aspose.cells/cell/get_dependents_in_calculation)
