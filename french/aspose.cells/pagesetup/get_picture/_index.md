...
| Paramètre| Taper| Description|
| :- | :- | :- |
| is_first | bool | Indique si l'image de l'en-tête/pied de page de la première page est obtenue.|
| is_even | bool | Indique si l'image de l'en-tête/pied de page est obtenue.|
| is_header | bool | Indique si l'image de l'en-tête/pied de page est obtenue.|
| section | int | : Section gauche, 1 : Section centrale, 2 : Section droite.|
