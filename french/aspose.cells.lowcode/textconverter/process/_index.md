...
type: docs
weight: 20
url: /fr/aspose.cells.lowcode/textconverter/process/
is_root: false
---
##  process(, fichier_modèle, fichier_résultat){#str-str}
Convertit le fichier modèle donné entre des fichiers texte et d'autres formats.
...
| :- | :- | :- |
| template_file | str | Le fichier modèle à convertir|
...
Convertit le format de fichier entre les formats texte et d'autres formats de fichiers de feuille de calcul
...
* classe [`TextConverter`](/cells/python-net/fr/aspose.cells.lowcode/textconverter)
