...
type: docs
weight: 20
url: /fr/aspose.cells.lowcode/spreadsheetconverter/process/
is_root: false
---
##  process(, fichier_modèle, fichier_résultat){#str-str}
Convertit le fichier modèle donné entre les formats de fichier de feuille de calcul.
...
Convertit entre différents formats de fichiers de feuille de calcul.
...
* classe [`SpreadsheetConverter`](/cells/python-net/fr/aspose.cells.lowcode/spreadsheetconverter)
