...
type: docs
weight: 20
url: /fr/aspose.cells.lowcode/htmlconverter/process/
is_root: false
---
##  process(, fichier_modèle, fichier_résultat){#str-str}
Convertit le fichier modèle donné entre HTML et d'autres formats.
...
Convertit le fichier entre HTML et d'autres formats de fichiers de feuille de calcul.
...
* classe [`HtmlConverter`](/cells/python-net/fr/aspose.cells.lowcode/htmlconverter)
