...
type: docs
weight: 20
url: /fr/aspose.cells.lowcode/pdfconverter/process/
is_root: false
---
##  process(, fichier_modèle, fichier_résultat){#str-str}
Convertit le fichier modèle donné en PDF.
...
| result_file | str |Le fichier résultant doit être un fichier PDF.|
...
Convertit le fichier modèle en PDF
...
* classe [`PdfConverter`](/cells/python-net/fr/aspose.cells.lowcode/pdfconverter)
