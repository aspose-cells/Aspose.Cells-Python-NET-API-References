---
title: méthode get_external_connection_by_id
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 50
url: /fr/aspose.cells.externalconnections/externalconnectioncollection/get_external_connection_by_id/
is_root: false
---
##  get_external_connection_by_id(self, conn_id) {#int}
Obtient l'élément ExternalConnection avec l'ID spécifié.


###  Retour

L'élément avec l'ID spécifié.
