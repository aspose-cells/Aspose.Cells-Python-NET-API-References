...
type: docs
weight: 170
url: /fr/aspose.cells.drawing.texts/textparagraph/line_space_size_type/
is_root: false
---
##  line_space_size_type propriété

Obtient et définit la quantité d'espace blanc vertical qui sera utilisé dans un paragraphe.
###  Définition:
```python
@property
